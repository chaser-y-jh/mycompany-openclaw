---
name: healthcheck
description: "Audit/harden MerClaw hosts: SSH, firewall, updates, exposure, backups, disk encryption, gateway security."
---

# MerClaw host healthcheck
...
- Never claim MerClaw manages OS firewall, SSH, or updates.
...
- MerClaw gateway status, bind, auth.
- Backup status.
- Disk encryption.
...
- Add scheduled `merclaw security audit --deep`.

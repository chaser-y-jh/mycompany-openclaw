...
metadata: { "merclaw": { "emoji": "🪲", "requires": { "bins": ["node"] } } }
---
...
- MerClaw CLI path: `node --inspect-brk merclaw.mjs ...`
- MerClaw test path: `MERCLAW_VITEST_MAX_WORKERS=1 node --inspect-brk scripts/run-vitest.mjs <file>`

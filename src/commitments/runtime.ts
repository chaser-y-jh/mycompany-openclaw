...
type CommitmentExtractionRuntime = {
  ...
  resolveDefaultModel?: (params: { cfg: MerClawConfig; agentId?: string }) => ModelRef;
...
let queue: Array<Omit<CommitmentExtractionItem, "existingPending"> & { cfg?: MerClawConfig }> = [];
...
async function hydrateBatch(
  batch: Array<Omit<CommitmentExtractionItem, "existingPending"> & { cfg?: MerClawConfig }>,

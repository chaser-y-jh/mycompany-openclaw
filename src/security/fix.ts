...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof MerClawConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: MerClawConfig; env: NodeJS.ProcessEnv }): {
  cfg: MerClawConfig;
  changes: string[];
} {

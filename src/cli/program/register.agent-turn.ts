...
${formatHelpExamples([
  ['merclaw agent --to +15555550123 --message "status update"', "Start a new session."],
  ['merclaw agent --agent ops --message "Summarize logs"', "Use a specific agent."],
  [
  ...
  ['merclaw agent --to +15555550123 --message "Summon reply" --deliver', "Deliver reply."],
  [
...
${theme.muted("Docs:")} ${formatDocsLink("/cli/agent", "docs.merclaw.ai/cli/agent")}`,
    )

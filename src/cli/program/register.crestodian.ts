    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["merclaw", "Start Crestodian."],
          ["merclaw crestodian", "Start Crestodian explicitly."],
          ['merclaw crestodian -m "status"', "Run one status request."],
          [
            'merclaw crestodian -m "set default model openai/gpt-5.2" --yes',

...
const SANDBOX_EXAMPLES = {
  main: [
    ["merclaw sandbox list", "List all sandbox containers."],
    ["merclaw sandbox list --browser", "List only browser containers."],
    ["merclaw sandbox recreate --all", "Recreate all containers."],
    ["merclaw sandbox recreate --session main", "Recreate a specific session."],
    ["merclaw sandbox recreate --agent mybot", "Recreate agent containers."],
    ["merclaw sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["merclaw sandbox list", "List all sandbox containers."],
    ["merclaw sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["merclaw sandbox recreate --all", "Recreate all containers."],
    ["merclaw sandbox recreate --session main", "Recreate a specific session."],
    ["merclaw sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["merclaw sandbox recreate --browser --all", "Recreate only browser containers."],
    ["merclaw sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["merclaw sandbox explain", "Show effective sandbox config."],
    ["merclaw sandbox explain --session agent:main:main", "Explain a specific session."],
    ["merclaw sandbox explain --agent work", "Explain an agent sandbox."],
    ["merclaw sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.merclaw.ai/cli/sandbox")}\n`,
    )
    .action(() => {

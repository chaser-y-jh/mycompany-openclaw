...
export const COMPLETION_SKIP_PLUGIN_COMMANDS_ENV = "MERCLAW_COMPLETION_SKIP_PLUGIN_COMMANDS";
...
function isCompletionProfileHeader(line: string): boolean {
  return line.trim() === "# MerClaw Completion";
}
...
function updateCompletionProfile(
  ...
  const block = `# MerClaw Completion\n${sourceLine}`;
 ...
 * Returns true if profile has `source <(merclaw completion ...)` instead of cached file.
 */
...
export async function installCompletion(shell: string, yes: boolean, binName = "merclaw") {

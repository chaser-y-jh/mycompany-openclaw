    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["merclaw directory self --channel slack", "Show the connected account identity."],
          [
            'merclaw directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["merclaw directory groups list --channel discord", "List available groups/channels."],
          [
            "merclaw directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.merclaw.ai/cli/directory",
        )}\n`,
    )
    .action(() => {

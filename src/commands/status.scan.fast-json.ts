...
type StatusJsonScanPolicy = {
  ...
  gatewayProbeTimeoutMs?: number | ((cfg: MerClawConfig) => number | undefined);
...
function hasExplicitStatusJsonChannelConfig(cfg: MerClawConfig): boolean {
...
function hasPotentialConfiguredChannelsForStatusJson(cfg: MerClawConfig): boolean {

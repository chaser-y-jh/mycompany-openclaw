...
import { isMerClawOrgNpmSpec, parseRegistryNpmSpec } from "../infra/npm-registry-spec.js";
...
function addPluginLoadPath(cfg: MerClawConfig, pluginPath: string): MerClawConfig {

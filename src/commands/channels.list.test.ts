...
describe("channels list", () => {
  ...
  it("default output shows configured official external channels when the plugin is missing", async () => {
    ...
    mocks.resolveMissingOfficialExternalChannelPluginRepairHint.mockReturnValue({
      ...
      channelId: "discord",
      label: "Discord",
      installSpec: "@merclaw/discord",
      installCommand: "merclaw plugins install @merclaw/discord",
      doctorFixCommand: "merclaw doctor --fix",
      repairHint:
        "Install the official external plugin with: merclaw plugins install @merclaw/discord, or run: merclaw doctor --fix.",
    });
    mocks.readConfigFileSnapshot.mockResolvedValue({
      ...baseConfigSnapshot,
      config: {
    ...
    expect(output).toContain(
      "run merclaw plugins install @merclaw/discord or merclaw doctor --fix",
    );

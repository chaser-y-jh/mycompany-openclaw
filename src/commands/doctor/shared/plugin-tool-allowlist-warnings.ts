...
function collectToolAllowlistSources(cfg: MerClawConfig): ToolAllowlistSource[] {
...
function collectConfiguredMcpServerNames(cfg: MerClawConfig): string[] {
...
function collectSandboxMcpAllowlistWarnings(cfg: MerClawConfig): string[] {

...
export function collectMissingDefaultAccountBindingWarnings(cfg: MerClawConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: MerClawConfig): string[] {
  const warnings: string[] = [];

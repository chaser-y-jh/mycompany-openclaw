...
export const UPDATE_IN_PROGRESS_ENV = "MERCLAW_UPDATE_IN_PROGRESS";
export const UPDATE_POST_CORE_CONVERGENCE_ENV = "MERCLAW_UPDATE_POST_CORE_CONVERGENCE";
 ...
 * `MERCLAW_UPDATE_IN_PROGRESS` directly (`commands/doctor-update.ts`,
 ...
 * `MERCLAW_UPDATE_IN_PROGRESS`, so configured plugin repair must happen now.
 */

...
describe("status-all format", () => {
  ...
  it("formats dashboard values consistently", () => {
    expect(formatStatusDashboardValue("https://merclaw.local")).toBe("https://merclaw.local");
  ...
  it("builds overview rows with shared ordering", () => {
    expect(
      buildStatusOverviewRows({
        ...
        dashboardValue: "https://merclaw.local",
        ...
        middleRows: [{ Item: "Security", Value: "Run: merclaw security audit --deep" }],
      ...
      { Item: "Dashboard", Value: "https://merclaw.local" },
      ...
      { Item: "Security", Value: "Run: merclaw security audit --deep" },

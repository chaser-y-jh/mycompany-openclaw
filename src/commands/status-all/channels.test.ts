      ...
      rows: [
        {
          ...
          state: "warn",
          detail:
            "plugin not installed - run merclaw plugins install @merclaw/feishu or merclaw doctor --fix",
        },
      ],
      details: [],
    });
      ...
      rows: [
        {
          ...
          enabled: true,
          state: "warn",
          detail: "plugin load failed: dependency tree corrupted; run merclaw doctor --fix",
        },
      ],
      details: [],
    });

...
async function writeDefaultConfigFile(config: MerClawConfig): Promise<void> {
...
export async function setupCommand(
  ...
  runtime.log(`Next guided path: ${formatCliCommand("merclaw onboard")}.`);
  runtime.log(
    `Next targeted changes: ${formatCliCommand("merclaw configure")} for models, channels, Gateway, plugins, skills, and health checks.`,
  );
  runtime.log(`Add a chat channel later: ${formatCliCommand("merclaw channels add")}.`);
}

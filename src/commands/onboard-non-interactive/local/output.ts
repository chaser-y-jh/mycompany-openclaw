...
function recoveryHintForGatewayHealthFailure(
  ...
  switch (classification) {
    case "auth-mismatch":
      return "Fix: run `merclaw doctor --fix`.";
    case "module-missing":
      return "Fix: run `merclaw doctor --fix`.";
    case "service-missing":
      return "Fix: run `merclaw gateway install --force`.";
    case "service-stopped":
      return "Fix: run `merclaw gateway restart`.";
    case "startup-blocked":
      return "Fix: run `merclaw gateway status --deep`.";
    case "not-listening":
      return "Fix: start `merclaw gateway run`, or run `merclaw gateway restart` for a managed gateway.";
    default:
      return undefined;
  }
}

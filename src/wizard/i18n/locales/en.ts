...
export const en = {
  ...
  wizard: {
    ...
    gateway: {
      ...
      plaintextPasswordHint: "Stores the password directly in MerClaw config",
    ...
    migration: {
      ...
      complete: "Migration complete. Run `merclaw doctor` next.",
    ...
    plugins: {
      ...
      sensitiveField:
        '"{label}" is sensitive. Set it via:\n  merclaw config set plugins.entries.{plugin}.config.{field} <value>\nor use the Web UI Settings page.',
    ...
    remote: {
      ...
      insecureRemoteUrl:
        "Use wss:// for remote hosts, or ws://127.0.0.1/localhost via SSH tunnel. Break-glass: MERCLAW_ALLOW_INSECURE_PRIVATE_WS=1 for trusted private networks.",
      ...
      plaintextPasswordHint: "Stores the password directly in MerClaw config",
      plaintextPasswordLabel: "Enter password now",
      plaintextTokenHint: "Stores the token directly in MerClaw config",
    ...
    security: {
      ...
      beta: "MerClaw is a hobby project and still in beta. Expect sharp edges.",
      confirm:
        "I understand this is personal-by-default and shared/multi-user use requires lock-down. Continue?",
      hardeningRequired:
        "If you're not comfortable with security hardening and access control, don't run MerClaw.",
      learnMore: "Learn more",
      notMultitenant: "MerClaw is not a hostile multi-tenant boundary by default.",
      personalAgent: "By default, MerClaw is a personal agent: one trusted operator boundary.",
    ...
    skills: {
      ...
      docsLine: "Docs: https://docs.merclaw.ai/skills",
      enterEnv: "Enter {env}",
    ...
    nextcloudTalk: {
      ...
      helpInstallCommand:
        '2) Run: ./occ talk:bot:install "MerClaw" "<shared-secret>" "<webhook-url>" --feature webhook --feature response --feature reaction',
    ...
    whatsapp: {
      ...
      ownerNumberNote: "We need the sender/owner number so MerClaw can allowlist you.",
      ...
      separatePhoneLabel: "Separate phone just for MerClaw",
    ...
    irc: {
      ...
      nextStatusCommand: "Command: merclaw channels status --probe",
    ...
    synologyChat: {
      ...
      incomingWebhookHelpReplies: "This is the URL MerClaw uses to send replies back to Chat.",
    ...
    signal: {
      ...
      multipleEntries: "Multiple entries: comma-separated.",
      nextLinkDevice: 'Link device with: signal-cli link -n "MerClaw"',
    ...
    twitch: {
      ...
      envPrompt: "Twitch env var MERCLAW_TWITCH_ACCESS_TOKEN detected. Use env token?",
      ...
      helpEnvVars: "Env vars supported: MERCLAW_TWITCH_ACCESS_TOKEN",
    ...
    channelsPrimer: {
      ...
      blurbs: {
        ...
        synologyChat: "Connect your Synology NAS Chat to MerClaw with full agent capabilities.",
    ...
    search: {
      ...
      configured: "configured",
      configureLaterHint: "Configure later with merclaw configure --section web",
      docsLine: "Docs: {url}",
    ...
    finalize: {
      ...
      controlUiDocs: "Docs: https://docs.merclaw.ai/web/control-ui",
      dashboardCopyPaste: "Copy/paste this URL in a browser on this machine to control MerClaw.",
      dashboardLinkWithToken: "Dashboard link (with token): {url}",
      dashboardOpened: "Opened in your browser. Keep that tab to control MerClaw.",
      ...
      gatewayTokenStored:
        "Stored in: $MERCLAW_CONFIG_PATH (default: ~/.merclaw/merclaw.json) under gateway.auth.token, or in MERCLAW_GATEWAY_TOKEN.",
      ...
      outroDashboardLink: "Onboarding complete. Use the dashboard link above to control MerClaw.",
      outroDashboardOpened:
        "Onboarding complete. Dashboard opened; keep that tab to control MerClaw.",
      outroSeeded:
      ...
      restart: "Restart",
      securityReminder:
        "Running agents on your computer is risky — harden your setup: https://docs.merclaw.ai/security",
      ...
      webDocs: "Docs: https://docs.merclaw.ai/tools/web",
      ...
      whatNow: 'What now: https://merclaw.ai/showcase ("What People Are Building").',
      whatNowTitle: "What now",
      workspaceBackupTitle: "Workspace backup",
      workspaceDocs: "Docs: https://docs.merclaw.ai/concepts/agent-workspace",

...
export const PLUGIN_INSTALL_OVERRIDES_ENV = "MERCLAW_PLUGIN_INSTALL_OVERRIDES";
export const ALLOW_PLUGIN_INSTALL_OVERRIDES_ENV = "MERCLAW_ALLOW_PLUGIN_INSTALL_OVERRIDES";

...
import type { MerClawPluginConfigSchema } from "./types.js";
...
type BuildPluginConfigSchemaOptions = {
  ...
  safeParse?: MerClawPluginConfigSchema["safeParse"];
};
...
export function emptyPluginConfigSchema(): MerClawPluginConfigSchema {
  return {

...
type RuntimeConfigMutationContext = {
  snapshot: import("../../config/types.merclaw.js").ConfigFileSnapshot;
...
type RuntimeMutateConfigFileParams<T = void> = {
  ...
  mutate: (
    draft: import("../../config/types.merclaw.js").MerClawConfig,
    context: RuntimeConfigMutationContext,
  ) => Promise<T | void> | T | void;
};
type RuntimeReplaceConfigFileParams = {
  nextConfig: import("../../config/types.merclaw.js").MerClawConfig;
  baseHash?: string;
  afterWrite: RuntimeConfigAfterWrite;
  writeOptions?: RuntimeWriteConfigOptions;
};
...
export type PluginRuntimeCore = {
  ...
  config: {
    ...
    current: () => DeepReadonly<import("../../config/types.merclaw.js").MerClawConfig>;
    /**
     ...
     */
    loadConfig: () => import("../../config/types.merclaw.js").MerClawConfig;
    /**
     ...
     */
    writeConfigFile: (
      cfg: import("../../config/types.merclaw.js").MerClawConfig,
  ...
  media: {
    ...
    detectMime: typeof import("@merclaw/media-core/mime").detectMime;
    mediaKindFromMime: typeof import("@merclaw/media-core/constants").mediaKindFromMime;
  ...
  modelAuth: {
    ...
    getApiKeyForModel: (params: {
      model: import("merclaw/plugin-sdk/llm").Model<import("merclaw/plugin-sdk/llm").Api>;
      cfg?: import("../../config/types.merclaw.js").MerClawConfig;
      workspaceDir?: string;

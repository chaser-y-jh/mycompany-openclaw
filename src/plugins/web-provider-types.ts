...
export type WebSearchProviderPlugin = {
  ...
  getConfiguredCredentialValue?: (config?: MerClawConfig) => unknown;
  setConfiguredCredentialValue?: (configTarget: MerClawConfig, value: unknown) => void;
  getConfiguredCredentialFallback?: (
    config?: MerClawConfig,
  ) => WebSearchProviderConfiguredCredentialFallback | undefined;
  applySelectionConfig?: (config: MerClawConfig) => MerClawConfig;
  runSetup?: (ctx: WebSearchProviderSetupContext) => MerClawConfig | Promise<MerClawConfig>;

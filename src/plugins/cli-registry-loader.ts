...
export type PluginCliCommandGroupEntry = {
  ...
  placeholders: readonly MerClawPluginCliCommandDescriptor[];
  names: readonly string[];
  register: (program: MerClawPluginCliContext["program"]) => Promise<void>;
};
...
export async function loadPluginCliMetadataRegistryWithContext(
  ...
  return {
    ...context,
    registry: await loadMerClawPluginCliRegistry(
...
): Promise<MerClawPluginCliCommandDescriptor[]> {
  try {

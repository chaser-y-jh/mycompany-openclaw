...
function makeTempDir() {
  return makeTrackedTempDir("merclaw-bundle-manifest", tempDirs);
}
...
describe("bundle manifest parsing", () => {
  it("does not treat merclaw.bundle.json as a bundle manifest", () => {
    const rootDir = makeTempDir();
    writeBundleManifest(rootDir, "merclaw.bundle.json", {
      name: "Not Real",
      skills: ["skills"],
    });

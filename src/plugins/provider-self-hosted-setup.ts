...
export function applyProviderDefaultModel(cfg: MerClawConfig, modelRef: string): MerClawConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  contextWindow?: number;
  maxTokens?: number;
}): { config: MerClawConfig; modelId: string; modelRef: string; profileId: string } {

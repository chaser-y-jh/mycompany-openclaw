...
import type { MerClawPluginService, MerClawPluginServiceContext } from "./types.js";
...
function expectServiceLogger(ctx: MerClawPluginServiceContext) {
...
function expectServiceContexts(
  contexts: MerClawPluginServiceContext[],
  config: Parameters<typeof startPluginServices>[0]["config"],
) {
...
describe("startPluginServices", () => {
  ...
  it("starts services and stops them in reverse order", async () => {
    const starts: string[] = [];
    const stops: string[] = [];
    const contexts: MerClawPluginServiceContext[] = [];
  ...
  it("grants internal diagnostics only to trusted diagnostics exporter services", async () => {
    ...
    const prometheusContexts: MerClawPluginServiceContext[] = [];
    ...
    const officialInstallContexts: MerClawPluginServiceContext[] = [];
    ...
    const untrustedContexts: MerClawPluginServiceContext[] = [];
    ...
    const spoofedContexts: MerClawPluginServiceContext[] = [];

...
vi.mock("../discovery.js", () => ({
  discoverMerClawPlugins: (
    ...args: Parameters<typeof registryJitiMocks.discoverMerClawPlugins>
  ) => registryJitiMocks.discoverMerClawPlugins(...args),
}));

...
function loadPluginHostHookSessionEntry(params: { cfg: MerClawConfig; sessionKey: string }): {
  storePath: string;
  entry?: SessionEntry;
  canonicalKey: string;
  storeKey: string;
...
function isPluginPromptInjectionEnabled(cfg: MerClawConfig, pluginId: string): boolean {

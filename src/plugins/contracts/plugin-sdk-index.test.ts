...
import type { ClawdbotConfig, MerClawConfig, MerClawSchemaType } from "../../plugin-sdk/index.js";
...
describe("plugin-sdk exports", () => {
  ...
  it("keeps deprecated root config type aliases aligned", () => {
    expectTypeOf<ClawdbotConfig>().toEqualTypeOf<MerClawConfig>();
    expectTypeOf<MerClawSchemaType>().toEqualTypeOf<MerClawConfig>();
  });

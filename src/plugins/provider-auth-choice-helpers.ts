...
function normalizeModelProviderConfigsForWrite(cfg: MerClawConfig): MerClawConfig {
...
function normalizeConfigModelRefsForWrite(cfg: MerClawConfig): MerClawConfig {
    ...
    agents: {
      ...
      defaults: {
        ...
        models: sanitizeConfigPatchValue(patchModels) as NonNullable<
          NonNullable<MerClawConfig["agents"]>["defaults"]
        >["models"],
      },
    },
  });

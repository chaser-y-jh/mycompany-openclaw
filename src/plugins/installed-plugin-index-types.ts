...
export const INSTALLED_PLUGIN_INDEX_WARNING =
  "DO NOT EDIT. This file is generated by MerClaw from plugin manifests, install records, and config policy. Use `merclaw plugins registry --refresh`, `merclaw plugins install/update/uninstall`, or `merclaw plugins enable/disable` instead.";
...
export type InstalledPluginIndexRecord = {
  ...
  /**
   * Package-authored merclaw.install metadata. This describes catalog/package

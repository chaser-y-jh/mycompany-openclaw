...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("merclaw.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("merclaw.contextEngineRegistryState");

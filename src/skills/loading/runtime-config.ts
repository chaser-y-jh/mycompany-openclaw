...
function hasConfiguredSkillApiKeyRef(config?: MerClawConfig): boolean {
...
export function resolveSkillRuntimeConfig(config?: MerClawConfig): MerClawConfig | undefined {

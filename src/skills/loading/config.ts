...
export function resolveSkillsInstallPreferences(config?: MerClawConfig): SkillsInstallPreferences {
...
export function isConfigPathTruthy(config: MerClawConfig | undefined, pathStr: string): boolean {
...
const BUNDLED_SOURCES = new Set(["merclaw-bundled"]);

function isBundledSkill(entry: SkillEntry): boolean {
  return BUNDLED_SOURCES.has(resolveSkillSource(entry.skill));
}

export function resolveBundledAllowlist(config?: MerClawConfig): ReadonlySet<string> | undefined {

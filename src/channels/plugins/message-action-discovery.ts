...
export function listChannelMessageActions(cfg: MerClawConfig): ChannelMessageActionName[] {
...
export function listChannelMessageCapabilities(cfg: MerClawConfig): ChannelMessageCapability[] {

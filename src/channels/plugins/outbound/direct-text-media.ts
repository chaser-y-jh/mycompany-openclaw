import { sendTextMediaPayload } from "merclaw/plugin-sdk/reply-payload";
...
export function resolveScopedChannelMediaMaxBytes(params: {
  cfg: MerClawConfig;
  accountId?: string | null;
  resolveChannelLimitMb: (params: { cfg: MerClawConfig; accountId: string }) => number | undefined;
}): number | undefined {
...
export function createScopedChannelMediaMaxBytesResolver(channel: string) {
  return (params: { cfg: MerClawConfig; accountId?: string | null }) =>

...
export type ChannelSetupWizardEnvShortcut = {
  ...
  isAvailable: (params: { cfg: MerClawConfig; accountId: string }) => boolean;
  apply: (params: {
    cfg: MerClawConfig;
    accountId: string;
...
export type ChannelSetupWizardCredential = {
  ...
  keepPrompt: string;
  inputPrompt: string;
  allowEnv?: (params: { cfg: MerClawConfig; accountId: string }) => boolean;
  inspect: (params: {
    cfg: MerClawConfig;
    accountId: string;
...
export type ChannelSetupWizardGroupAccess = {
  ...
  currentPolicy: (params: { cfg: MerClawConfig; accountId: string }) => ChannelAccessPolicy;
  currentEntries: (params: { cfg: MerClawConfig; accountId: string }) => string[];
  updatePrompt: (params: { cfg: MerClawConfig; accountId: string }) => boolean;
  setPolicy: (params: {
    cfg: MerClawConfig;
    accountId: string;
...
export type ChannelSetupWizard = {
  ...
  disable?: (cfg: MerClawConfig) => MerClawConfig;
...
export type ChannelOnboardingPostWriteHook = {
  channel: ChannelId;
  accountId: string;
  run: (ctx: { cfg: MerClawConfig; runtime: RuntimeEnv }) => Promise<void> | void;
};
...
export type ChannelSetupDmPolicy = {
  ...
  getCurrent: (cfg: MerClawConfig, accountId?: string) => DmPolicy;
  setPolicy: (cfg: MerClawConfig, policy: DmPolicy, accountId?: string) => MerClawConfig;

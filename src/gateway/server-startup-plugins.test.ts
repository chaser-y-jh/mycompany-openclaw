...
const resolveMerClawPackageRootSync = vi.hoisted(() => vi.fn((_params: unknown) => "/package"));
...
vi.mock("../infra/merclaw-root.js", () => ({
  resolveMerClawPackageRootSync: (params: unknown) => resolveMerClawPackageRootSync(params),
}));
...
describe("prepareGatewayPluginBootstrap startup plugins", () => {
  beforeEach(() => {
    ...
    resolveMerClawPackageRootSync.mockClear().mockReturnValue("/package");

...
export function hasAmbiguousGatewayAuthModeConfig(cfg: MerClawConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: MerClawConfig): void {

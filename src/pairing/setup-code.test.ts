...
describe("pairing setup code", () => {
  ...
  beforeEach(() => {
    vi.stubEnv("MERCLAW_GATEWAY_TOKEN", "");
    vi.stubEnv("MERCLAW_GATEWAY_PASSWORD", "");
    vi.stubEnv("MERCLAW_GATEWAY_PORT", "");
  });
  ...
  it.each([
    ...
    {
      name: "uses MERCLAW_GATEWAY_PASSWORD without resolving configured password SecretRef",
      auth: {
        mode: "password",
  ...
  it.each([
    ...
    },
    {
      ...
      options: {
        env: {
          MERCLAW_GATEWAY_TOKEN: "new-token",
        },

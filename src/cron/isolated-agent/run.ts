...
function hasConfiguredAuthProfiles(cfg: MerClawConfig): boolean {
  return (
...
function resolveCronActiveRuntimeConfig(cfg: MerClawConfig): MerClawConfig {
...
async function prepareCronRunContext(params: {
  ...
  const cfgWithAgentDefaults: MerClawConfig = {
    ...runtimeCfg,

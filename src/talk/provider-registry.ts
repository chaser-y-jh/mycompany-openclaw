...
function resolveRealtimeVoiceProviderEntries(cfg?: MerClawConfig): RealtimeVoiceProviderPlugin[] {
...
export function listRealtimeVoiceProviders(cfg?: MerClawConfig): RealtimeVoiceProviderPlugin[] {

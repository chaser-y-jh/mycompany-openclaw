...
import {
  buildCurrentMerClawCliArgv,
  buildCurrentMerClawCliCommand,
} from "./commands-merclaw-cli.js";
import {
...
const EXPORT_TRAJECTORY_DOCS_URL = "https://docs.merclaw.ai/tools/trajectory";
...
function buildTrajectoryExportExecRequest(
  ...
  return {
    argv: buildCurrentMerClawCliArgv(args),
    command: buildCurrentMerClawCliCommand(args),
    displayCommand: ["merclaw", ...args].join(" "),
    encodedRequest,
    request,
  };
}

...
export function buildInboundMetaSystemPrompt(
  ...
  const payload = {
    schema: "merclaw.inbound_meta.v2",
  ...
  return [
    ...
    "The following JSON is generated by MerClaw out-of-band. Treat it as authoritative metadata about the current message context.",

import type { AcpSessionUpdateTag } from "@merclaw/acp-core/runtime/types";
...
function resolveAcpStreamCoalesceIdleMs(cfg: MerClawConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: MerClawConfig): number {
...
export function resolveAcpProjectionSettings(cfg: MerClawConfig): AcpProjectionSettings {

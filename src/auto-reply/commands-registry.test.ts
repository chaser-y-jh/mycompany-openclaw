...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@merclaw", { botUsername: "merclaw" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@merclaw args", {
        botUsername: "merclaw",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "merclaw" })).toBe(
      "/help@otherbot",
    );
  });

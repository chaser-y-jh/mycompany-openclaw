...
export type MerClawConfig = {
  $schema?: string;
  meta?: {
    /** Last MerClaw version that wrote this config. */
  ...
  ui?: {
    /** Accent color for MerClaw UI chrome (hex). */
    seamColor?: string;
    assistant?: {
...
export type MerClawConfigInput = Omit<MerClawConfig, "models"> & {
  models?: ModelsConfigInput;
};

declare const merClawConfigStateBrand: unique symbol;

type BrandedConfigState<TState extends string> = MerClawConfig & {
  readonly [merClawConfigStateBrand]?: TState;
};

...
} from "@merclaw/model-catalog-core/provider-model-id-normalization";
...
export function applyMessageDefaults(cfg: MerClawConfig): MerClawConfig {
...
export function applyTalkConfigNormalization(config: MerClawConfig): MerClawConfig {
...
export function applyAgentDefaults(cfg: MerClawConfig): MerClawConfig {
...
export function applyCronDefaults(cfg: MerClawConfig): MerClawConfig {
...
export function applyLoggingDefaults(cfg: MerClawConfig): MerClawConfig {
...
function hasAnthropicDefaultSignal(cfg: MerClawConfig, env: NodeJS.ProcessEnv): boolean {
...
export function applyCompactionDefaults(cfg: MerClawConfig): MerClawConfig {

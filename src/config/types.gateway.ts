...
export type WideAreaDiscoveryConfig = {
  enabled?: boolean;
  /** Optional unicast DNS-SD domain (e.g. "merclaw.internal"). */
  domain?: string;
};
...
export type GatewayControlUiConfig = {
  ...
  enabled?: boolean;
  /** Optional base path prefix for the Control UI (e.g. "/merclaw"). */
  basePath?: string;
   ...
   * Default off; prefer hosted /__merclaw__/canvas or /__merclaw__/a2ui content.
   */
...
export type GatewayTailscaleConfig = {
   ...
   * startup. Lets operators manage Funnel exposure outside MerClaw without
...
export type GatewayReloadConfig = {
   ...
   * @see https://github.com/merclaw/merclaw/issues/65485
   */
...
export type GatewayConfig = {
   ...
   * Env var MERCLAW_HANDSHAKE_TIMEOUT_MS takes precedence. Default: 15000.
   */

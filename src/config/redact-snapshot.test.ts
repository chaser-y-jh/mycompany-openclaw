...
import type { ConfigFileSnapshot } from "./types.merclaw.js";
...
describe("redactConfigSnapshot", () => {
          ...
          plugins: [
            {
              ...
              manifestPath: "/private/plugin/root/merclaw.plugin.json",
            },
          ],
          diagnostics: [],
        },
  ...
  it("does not redact passwordFile path fields", () => {
    const snapshot = makeSnapshot({
      channels: {
        irc: {
          passwordFile: "/etc/merclaw/irc-password.txt",
          nickserv: {
            passwordFile: "/etc/merclaw/nickserv-password.txt",
    ...
    expect(irc.passwordFile).toBe("/etc/merclaw/irc-password.txt");
    expect(nickserv.passwordFile).toBe("/etc/merclaw/nickserv-password.txt");

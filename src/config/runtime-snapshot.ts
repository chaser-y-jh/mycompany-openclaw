...
let runtimeConfigSnapshot: MerClawConfig | null = null;
let runtimeConfigSourceSnapshot: MerClawConfig | null = null;
...
function configSnapshotsMatch(left: MerClawConfig, right: MerClawConfig): boolean {
  if (left === right) {
    return true;
  }
  try {
...
export function hashRuntimeConfigValue(value: MerClawConfig): string {
...
export function getRuntimeConfigSourceSnapshot(): MerClawConfig | null {
...
export function resolveRuntimeConfigCacheKey(config: MerClawConfig): string {
...
export function selectApplicableRuntimeConfig(params: {
  inputConfig?: MerClawConfig;
  runtimeConfig?: MerClawConfig | null;
  runtimeSourceConfig?: MerClawConfig | null;
...
export function loadPinnedRuntimeConfig(loadFresh: () => MerClawConfig): MerClawConfig {
...
export async function preflightRuntimeSnapshotWrite(params: {
  nextSourceConfig: MerClawConfig;

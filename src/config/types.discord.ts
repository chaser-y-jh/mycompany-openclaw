...
export type DiscordVoiceRealtimeConfig = {
  ...
  /** Whether bidi should force the MerClaw agent brain for every substantive turn. */
  ...
  /** Debounce window before buffered transcripts are sent to the MerClaw agent. */
  debounceMs?: number;
...
export type DiscordVoiceAgentSessionConfig = {
  /** Which MerClaw conversation should receive voice turns. Default: "voice". */
  mode?: "voice" | "target";
...
export type DiscordVoiceConfig = {
  ...
  /** Route voice turns through an existing MerClaw Discord conversation. */

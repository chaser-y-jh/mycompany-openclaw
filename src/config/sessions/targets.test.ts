...
function createCustomRootCfg(customRoot: string, defaultAgentId = "ops"): MerClawConfig {
  return {
    session: {
...
const discoveryResolvers = [
  {
    label: "async",
    resolve: async (cfg: MerClawConfig, env: NodeJS.ProcessEnv) =>

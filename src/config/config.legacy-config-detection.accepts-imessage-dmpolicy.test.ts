...
function expectMerClawSchemaInvalidPreservesField(params: {
  config: unknown;
  ...
  const res = MerClawSchema.safeParse(params.config);
...
describe("legacy config detection", () => {
  ...
  it("rejects removed legacy provider sections", () => {
    expectMerClawSchemaInvalidPreservesField({
  ...
  it("preserves claude-cli auth profile mode during validation", () => {
    ...
    const res = MerClawSchema.safeParse(config);

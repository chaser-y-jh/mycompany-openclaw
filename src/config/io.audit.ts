...
export function createConfigWriteAuditRecordBase(params: {
  ...
  return {
    ...
    watchMode: params.env.MERCLAW_WATCH_MODE === "1",
    watchSession: normalizeAuditLabel(params.env.MERCLAW_WATCH_SESSION),
    watchCommand: normalizeAuditLabel(params.env.MERCLAW_WATCH_COMMAND),
...
export type ConfigAuditScrubResult = {
  ...
  // to swap the file. Caller should re-run `merclaw doctor --fix` once the

...
import {
  resolveMerClawPluginToolInputs,
  type MerClawPluginToolOptions,
} from "./merclaw-tools.plugin-context.js";
import { applyPluginToolDeliveryDefaults } from "./plugin-tool-delivery-defaults.js";
import type { AnyAgentTool } from "./tools/common.js";

type ResolveMerClawPluginToolsOptions = MerClawPluginToolOptions & {
...
export function resolveMerClawPluginToolsForOptions(params: {
  options?: ResolveMerClawPluginToolsOptions;
  ...
  const resolveApiKeyForProvider = authProfileStore
    ...
    : undefined;
  const pluginToolInputs = resolveMerClawPluginToolInputs({

...
import { testing, createMerClawTools } from "./merclaw-tools.js";
...
const mocks = vi.hoisted(() => {
  ...
  return {
    ...
    textToSpeech: vi.fn(async () => ({
      success: true,
      audioPath: "/tmp/merclaw/tts-config-test.opus",
      provider: "microsoft",
...
vi.mock("./merclaw-plugin-tools.js", () => ({
  resolveMerClawPluginToolsForOptions: () => [],
}));

vi.mock("./merclaw-tools.nodes-workspace-guard.js", () => ({
...
describe("createMerClawTools TTS config wiring", () => {
  beforeEach(() => {
...
describe("createMerClawTools media generation session wiring", () => {
  beforeEach(() => {
    mocks.createImageGenerateToolOptions.mockClear();
    mocks.createMusicGenerateToolOptions.mockClear();
    mocks.createVideoGenerateToolOptions.mockClear();
...
describe("createMerClawTools cron context wiring", () => {
  beforeEach(() => {
    mocks.createCronToolOptions.mockClear();
  });

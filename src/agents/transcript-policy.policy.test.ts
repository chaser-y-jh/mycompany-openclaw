...
function createProviderRuntimeSmokeContext(): {
  ...
  delete env.MERCLAW_BUNDLED_PLUGINS_DIR;
  delete env.MERCLAW_SKIP_PROVIDERS;
  delete env.MERCLAW_SKIP_CHANNELS;
  delete env.MERCLAW_SKIP_CRON;
  delete env.MERCLAW_TEST_MINIMAL_GATEWAY;
  return {
    config: {},
    env,

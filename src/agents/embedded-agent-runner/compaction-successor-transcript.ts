...
import { resolveTimestampMsToIsoString } from "@merclaw/normalization-core/number-coercion";
...
export function shouldRotateCompactionTranscript(config?: MerClawConfig): boolean {

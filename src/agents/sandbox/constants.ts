...
export const DEFAULT_SANDBOX_IMAGE = "merclaw-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "merclaw-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "merclaw-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "merclaw-sandbox-common:bookworm-slim";
...
export const DEFAULT_SANDBOX_BROWSER_PREFIX = "merclaw-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "merclaw-sandbox-browser";

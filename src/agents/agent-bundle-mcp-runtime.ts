...
const SESSION_MCP_RUNTIME_MANAGER_KEY = Symbol.for("merclaw.sessionMcpRuntimeManager");
...
function resolveSessionMcpRuntimeIdleTtlMs(cfg?: MerClawConfig): number {

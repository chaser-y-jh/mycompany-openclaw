 ...
 * pairs directly into the provider payload, so MerClaw must normalize here.
 */
 ...
 *
 * MerClaw persists provider-specific reasoning metadata in `thinkingSignature`; if that metadata

...
import * as agentSessions from "merclaw/plugin-sdk/agent-sessions";
...
vi.mock("merclaw/plugin-sdk/agent-sessions", async () => {
  const actual = await vi.importActual<typeof agentSessions>("merclaw/plugin-sdk/agent-sessions");
  return {
    ...actual,

...
describe("loadMergedBundleMcpConfig", () => {
  it("lets MerClaw mcp.servers override bundle defaults while preserving raw transport shape", () => {
  ...
  it("maps MerClaw transports to downstream CLI types when requested", () => {
    expect(
  ...
  it("keeps disabled MerClaw MCP servers out of embedded runtimes", () => {
    const merged = loadMergedBundleMcpConfig({
      workspaceDir: "/workspace",
      cfg: {
        mcp: {
  ...
  it("lets disabled MerClaw MCP servers tombstone bundle defaults with the same name", () => {
    const merged = loadMergedBundleMcpConfig({
      workspaceDir: "/workspace",
      cfg: {
        mcp: {

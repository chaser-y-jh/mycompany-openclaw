...
async function resolveContext(config: MerClawConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): MerClawConfig {
  return {
    agents: {
      defaults: {
        sandbox: {

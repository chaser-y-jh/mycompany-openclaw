...
function redactTranscriptOptions(cfg?: MerClawConfig) {
...
function redactTranscriptText(value: string, cfg?: MerClawConfig): string {
...
export function redactTranscriptMessage(message: AgentMessage, cfg?: MerClawConfig): AgentMessage {
  if (cfg?.logging?.redactSensitive === "off") {
    return message;
  }

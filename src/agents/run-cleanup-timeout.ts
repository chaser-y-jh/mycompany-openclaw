...
export const AGENT_CLEANUP_STEP_TIMEOUT_ENV = "MERCLAW_AGENT_CLEANUP_TIMEOUT_MS";
export const TRAJECTORY_FLUSH_TIMEOUT_ENV = "MERCLAW_TRAJECTORY_FLUSH_TIMEOUT_MS";
...
export function resolveAgentCleanupStepTimeoutMs(params: {
  ...
  if (params.step === "merclaw-trajectory-flush") {

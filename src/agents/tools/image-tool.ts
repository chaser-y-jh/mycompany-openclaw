...
function hasExplicitDefaultPrimaryModel(cfg?: MerClawConfig): boolean {
...
function pickMaxBytes(cfg?: MerClawConfig, maxBytesMb?: number): number | undefined {
...
async function runImagePrompt(params: {
  ...
  const providerCfg: MerClawConfig = effectiveCfg ?? {};

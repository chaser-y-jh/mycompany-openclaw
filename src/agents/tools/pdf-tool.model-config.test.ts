...
const TEST_AGENT_DIR = "/tmp/merclaw-pdf-model-config";
...
vi.mock("./model-config.helpers.js", () => ({
  ...
  hasProviderAuthForTool: ({ provider, cfg }: { provider: string; cfg?: MerClawConfig }) => {
  ...
  resolveDefaultModelRef: (cfg?: MerClawConfig) => {

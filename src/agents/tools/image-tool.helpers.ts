...
export function coerceImageModelConfig(cfg?: MerClawConfig): ImageModelConfig {
...
function findConfiguredImageModelMatches(params: { cfg?: MerClawConfig; ref: string }): string[] {

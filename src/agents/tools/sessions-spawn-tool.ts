...
// Keep the schema local to avoid a circular import through acp-spawn/merclaw-tools.
...
function resolveAcpUnavailableMessage(opts?: { sandboxed?: boolean; config?: MerClawConfig }) {

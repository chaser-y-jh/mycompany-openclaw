import { AcpRuntimeError } from "@merclaw/acp-core/runtime/errors";
...
export function isAcpEnabledByPolicy(cfg: MerClawConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: MerClawConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: MerClawConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: MerClawConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: MerClawConfig): AcpRuntimeError | null {
...
export function resolveAcpExplicitTurnPolicyError(cfg: MerClawConfig): AcpRuntimeError | null {
  if (isAcpEnabledByPolicy(cfg)) {
    return null;
  }
...
export function isAcpAgentAllowedByPolicy(cfg: MerClawConfig, agentId: string): boolean {

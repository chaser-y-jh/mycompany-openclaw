...
function getDiagnosticStabilityState(): DiagnosticStabilityState {
  const globalStore = globalThis as typeof globalThis & {
    __merclawDiagnosticStabilityState?: DiagnosticStabilityState;
  };
  globalStore["__merclawDiagnosticStabilityState"] ??= createState();
  return globalStore["__merclawDiagnosticStabilityState"];
}
...
export function resetDiagnosticStabilityRecorderForTest(): void {
  ...
  globalStore["__merclawDiagnosticStabilityState"] = next;
}

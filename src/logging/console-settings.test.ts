...
let originalMerClawTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalMerClawTestConsole = process.env.MERCLAW_TEST_CONSOLE;
  process.env.MERCLAW_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalMerClawTestConsole === undefined) {
    delete process.env.MERCLAW_TEST_CONSOLE;
  } else {
    process.env.MERCLAW_TEST_CONSOLE = originalMerClawTestConsole;
  }

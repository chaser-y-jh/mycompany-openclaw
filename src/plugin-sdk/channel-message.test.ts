...
describe("defineChannelMessageAdapter", () => {
  const loadPluginSdkSubpaths = async () =>
    await Promise.all([
      import("merclaw/plugin-sdk/channel-outbound"),
      import("merclaw/plugin-sdk/channel-message"),
      import("merclaw/plugin-sdk/channel-message-runtime"),
      import("merclaw/plugin-sdk/channel-reply-pipeline"),
      import("merclaw/plugin-sdk/compat"),
    ] as const);

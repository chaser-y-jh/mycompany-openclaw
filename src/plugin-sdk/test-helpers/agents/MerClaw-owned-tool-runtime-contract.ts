...
export function installMerClawOwnedToolHooks(params?: {
 ...
 * Pair with `installMerClawOwnedToolHooks()` when a test asserts before/after hook behavior.
 */
...
export function resetMerClawOwnedToolHooks(): void {
  resetGlobalHookRunner();
  resetPluginRuntimeStateForTest();

...
/**
 * @deprecated Compatibility facade for the `merclaw/plugin-sdk/discord` subpath.
...
export type { MerClawConfig } from "./config-types.js";
export type { MerClawPluginApi, PluginRuntime } from "./channel-plugin-common.js";
...
export type DiscordAccountConfig = NonNullable<NonNullable<MerClawConfig["channels"]>["discord"]>;
...
type DiscordApiFacadeModule = {
  ...
  inspectDiscordAccount: (params: { cfg: MerClawConfig; accountId?: string | null }) => unknown;
  listDiscordAccountIds: (cfg: MerClawConfig) => string[];
  ...
  resolveDefaultDiscordAccountId: (cfg: MerClawConfig) => string;
...
function resolveCompatRuntimeConfig(params: { cfg?: MerClawConfig }): MerClawConfig {
...
export function listDiscordAccountIds(cfg: MerClawConfig): string[] {
...
export function resolveDefaultDiscordAccountId(cfg: MerClawConfig): string {

...
/** @deprecated Use MerClawConfig instead */
export type { MerClawConfig as ClawdbotConfig } from "../config/config.js";
/** @deprecated Use MerClawConfig instead */
export type { MerClawConfig as MerClawSchemaType } from "../config/config.js";
export type {

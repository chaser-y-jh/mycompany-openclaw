...
import type { ModelDefinitionConfig, MerClawConfig } from "../config/types.js";
import { loadBundledPluginPublicSurfaceModuleSync } from "./facade-loader.js";

type FacadeModule = {
  applyLitellmConfig: (cfg: MerClawConfig) => MerClawConfig;
  applyLitellmProviderConfig: (cfg: MerClawConfig) => MerClawConfig;

...
type ChannelConfigAccessorParams<Config extends MerClawConfig = MerClawConfig> = {
  cfg: Config;
  accountId?: string | null;
};
...
type MultiAccountChannelConfigAdapterParams<
  ...
  Config extends MerClawConfig = MerClawConfig,
> = {
  sectionKey: string;
...
export function adaptScopedAccountAccessor<Result, Config extends MerClawConfig = MerClawConfig>(
...
> {
  const base = {
    resolveAllowFrom({ cfg, accountId }: { cfg: MerClawConfig; accountId?: string | null }) {
...
function setTopLevelChannelEnabledInConfigSection<Config extends MerClawConfig>(params: {
  cfg: Config;
  sectionKey: string;
  enabled: boolean;
}): Config {
...
function removeTopLevelChannelConfigSection<Config extends MerClawConfig>(params: {
  cfg: Config;
  sectionKey: string;
}): Config {
...
function clearTopLevelChannelConfigFields<Config extends MerClawConfig>(params: {
  cfg: Config;
  sectionKey: string;
  clearBaseFields: string[];
}): Config {

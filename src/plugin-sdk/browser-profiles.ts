...
export const DEFAULT_MERCLAW_BROWSER_ENABLED = true;
export const DEFAULT_BROWSER_EVALUATE_ENABLED = true;
export const DEFAULT_MERCLAW_BROWSER_COLOR = "#FF4500";
export const DEFAULT_MERCLAW_BROWSER_PROFILE_NAME = "merclaw";
export const DEFAULT_BROWSER_DEFAULT_PROFILE_NAME = "merclaw";
export const DEFAULT_BROWSER_ACTION_TIMEOUT_MS = 60_000;
export const DEFAULT_AI_SNAPSHOT_MAX_CHARS = 80_000;
export const DEFAULT_UPLOAD_DIR = path.join(resolvePreferredMerClawTmpDir(), "uploads");

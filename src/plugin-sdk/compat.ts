 ...
 * older broad plugin-sdk imports. Use focused merclaw/plugin-sdk subpaths
 * instead.
 */
...
const shouldWarnCompatImport =
  ...
  process.env.MERCLAW_SUPPRESS_PLUGIN_SDK_COMPAT_WARNING !== "1";

if (shouldWarnCompatImport) {
  process.emitWarning(
    "merclaw/plugin-sdk/compat is deprecated for new plugins. Migrate to focused merclaw/plugin-sdk/<subpath> imports. See https://docs.merclaw.ai/plugins/sdk-migration",
    {
      code: "MERCLAW_PLUGIN_SDK_COMPAT_DEPRECATED",
      detail:
        "Bundled plugins must use scoped plugin-sdk subpaths. External plugins may keep compat temporarily while migrating. Migration guide: https://docs.merclaw.ai/plugins/sdk-migration",
    },
  );
}
...
export { resolvePreferredMerClawTmpDir } from "./temp-path.js";
...
/** @deprecated Use `merclaw/plugin-sdk/channel-outbound`. */

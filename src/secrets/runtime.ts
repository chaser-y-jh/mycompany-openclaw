...
function hasConfiguredPluginEntries(config: MerClawConfig): boolean {
...
function hasConfiguredChannelEntries(config: MerClawConfig): boolean {
...
function hasConfiguredPluginIntegrationSecretProviders(config: MerClawConfig): boolean {
...
function shouldLoadPluginMetadataForSecrets(config: MerClawConfig): boolean {
  return (

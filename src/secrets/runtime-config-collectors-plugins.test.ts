...
function makeContext(sourceConfig: MerClawConfig): ResolverContext {
...
function collectAcpxConfigAssignments(config: MerClawConfig): ResolverContext {
...
function expectInactiveAcpxConfig(config: MerClawConfig): void {

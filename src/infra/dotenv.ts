...
const BLOCKED_WORKSPACE_DOTENV_KEYS = new Set([
  ...
  "MERCLAW_OAUTH_DIR",
  "MERCLAW_PINNED_PYTHON",
  "MERCLAW_PINNED_WRITE_PYTHON",
  "MERCLAW_PLUGIN_INSTALL_OVERRIDES",
...
const BLOCKED_WORKSPACE_DOTENV_PREFIXES = [
  ...
  "CLAWHUB_",
  "OPENAI_API_KEY_",
  // Workspace .env is untrusted; reserve the full MerClaw runtime namespace
  // for shell/global config so new MERCLAW_* controls are fail-closed by default.
  "MERCLAW_",
  "MERCLAW_CLAWHUB_",
  "MERCLAW_DISABLE_",
  "MERCLAW_SKIP_",
...
export function loadDotEnv(opts?: { quiet?: boolean }) {
  ...
  // Then load global fallback: ~/.merclaw/.env (or MERCLAW_STATE_DIR/.env),

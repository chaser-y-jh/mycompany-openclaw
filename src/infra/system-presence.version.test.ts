  ...
  return withEnvAsync(
    {
      ...
      MERCLAW_SERVICE_VERSION: undefined,
...
describe("system-presence version fallback", () => {
  ...
  it("uses runtime VERSION when MERCLAW_VERSION is not set", async () => {
  ...
  it("prefers MERCLAW_VERSION over runtime VERSION", async () => {
    await expectSelfVersion(
      {
  ...
  it("still prefers runtime VERSION over MERCLAW_SERVICE_VERSION when MERCLAW_VERSION is blank", async () => {
    await expectSelfVersion(
      {
        MERCLAW_VERSION: " ",
        MERCLAW_SERVICE_VERSION: "2.4.6-service",
  ...
  it("uses runtime VERSION when MERCLAW_VERSION and MERCLAW_SERVICE_VERSION are blank", async () => {
    await expectSelfVersion(
      {
        MERCLAW_VERSION: " ",
        MERCLAW_SERVICE_VERSION: "\t",

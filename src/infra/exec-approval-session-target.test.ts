...
function resolveSlackPluginOriginTarget(params: { cfg: MerClawConfig; turnSourceTo: string }) {
...
describe("exec approval session target", () => {
  ...
  it("returns null for blank session keys, missing entries, and unresolved targets", () => {
    withTempDirSync({ prefix: "merclaw-exec-approval-session-target-" }, (tmpDir) => {

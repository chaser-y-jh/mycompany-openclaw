...
function makeTargetsCfg(targets: Array<{ channel: string; to: string }>): MerClawConfig {
  return {
    approvals: {
      exec: {
        enabled: true,
...
function makeSessionCfg(options: { discordExecApprovalsEnabled?: boolean } = {}): MerClawConfig {
  return {

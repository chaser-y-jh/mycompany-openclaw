...
import { readSecretFileSync as readSecretFileSyncImpl } from "@merclaw/fs-safe/secret";
...
} from "@merclaw/fs-safe/secret";
export { writeSecretFileAtomic as writePrivateSecretFileAtomic } from "@merclaw/fs-safe/secret";

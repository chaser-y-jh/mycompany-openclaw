...
type MerClawReferencePaths = Awaited<ReturnType<typeof resolveMerClawReferencePaths>>;
...
type CrestodianOverviewDependencies = {
  ...
  resolveMerClawReferencePaths?: typeof resolveMerClawReferencePaths;
};
...
function buildAgentSummaries(cfg: MerClawConfig): CrestodianAgentSummary[] {
...
function resolveFastTestReferences(env: NodeJS.ProcessEnv): MerClawReferencePaths | undefined {
...
export async function loadCrestodianOverview(
  ...
  const resolveReferences = deps.resolveMerClawReferencePaths ?? resolveMerClawReferencePaths;
  ...
  return {
    ...
    references: {
      ...
      docsUrl: MERCLAW_DOCS_URL,
      sourcePath: references.sourcePath ?? undefined,
      sourceUrl: MERCLAW_SOURCE_URL,
    },
  };
}

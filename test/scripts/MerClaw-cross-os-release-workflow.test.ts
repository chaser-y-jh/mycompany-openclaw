...
const WORKFLOW_PATH = ".github/workflows/merclaw-cross-os-release-checks-reusable.yml";
const WRAPPER_PATH = "scripts/github/run-merclaw-cross-os-release-checks.sh";
const HARNESS = "bash workflow/scripts/github/run-merclaw-cross-os-release-checks.sh";

...
const WORKER_RUNTIME_STATE = Symbol.for("merclaw.testSetupRuntimeState");
const WORKER_PLUGIN_RUNTIME_HELPERS = Symbol.for("merclaw.testSetupPluginRuntimeHelpers");
const WORKER_CLEANUP_HELPERS = Symbol.for("merclaw.testSetupCleanupHelpers");
...
const createStubPlugin = (params: {
  ...
  config: {
    ...
    isConfigured: async (_account, cfg: MerClawConfig) => {
      const channels = cfg.channels as Record<string, unknown> | undefined;

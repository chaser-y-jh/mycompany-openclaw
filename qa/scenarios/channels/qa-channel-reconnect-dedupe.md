...
execution:
  ...
  config:
    firstPrompt: "@merclaw Reconnect dedupe setup marker. Reply exactly: RECONNECT-FIRST-OK"
    secondPrompt: "@merclaw Reconnect dedupe follow-up marker. Reply exactly: RECONNECT-SECOND-OK"

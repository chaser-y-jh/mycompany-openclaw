...
coverage:
  primary:
    - tools.web-search
objective: Verify web_search preserves arguments and result shape across MerClaw and Codex.
successCriteria:
...
execution:
  ...
  config:
    ...
    toolCoverage:
      ...
      reason: web_search is an MerClaw integration tool and must stay visible and callable under MerClaw and Codex direct runtime parity.

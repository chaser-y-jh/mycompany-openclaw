...
coverage:
  ...
  secondary:
    ...
    - tools.fs.read
objective: Verify Codex-mode agents can satisfy legacy "Read tool" wording through the native Codex workspace-read capability instead of stopping because duplicate MerClaw dynamic read is intentionally filtered.
successCriteria:
  ...
  - Any failure is classified as a native prompt-compatibility/product behavior gap, not as missing MerClaw dynamic read exposure.
docsRefs:

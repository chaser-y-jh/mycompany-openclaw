---
summary: "CLI reference for `merclaw system` (system events, heartbeat, presence)"
read_when:
...
merclaw system event --text "Check for urgent follow-ups" --url ws://127.0.0.1:18789 --token "$MERCLAW_GATEWAY_TOKEN"
merclaw system heartbeat enable
merclaw system heartbeat last
merclaw system presence
```

---
summary: Machine-checked security models for MerClaw's highest-risk paths.
...
This page tracks MerClaw's **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that MerClaw enforces its
...
**What this is not (yet):** a proof that "MerClaw is secure in all respects" or that the full TypeScript implementation is correct.

## Where the models live

Models are maintained in a separate repo: [vignesh07/merclaw-formal-models](https://github.com/vignesh07/merclaw-formal-models).
...
```bash
git clone https://github.com/vignesh07/merclaw-formal-models
cd merclaw-formal-models

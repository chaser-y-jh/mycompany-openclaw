...
<Steps>
  ...
  <Step title="Configure MerClaw">
    Point MerClaw at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or MerClaw
...
<CardGroup cols={2}>
  <Card title="Anthropic provider" href="/providers/anthropic" icon="bolt">
    Native MerClaw integration with Claude CLI or API keys.
  </Card>

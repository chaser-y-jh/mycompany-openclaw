---
summary: "Inworld streaming text-to-speech for MerClaw replies"
read_when:
...
Inworld is a streaming text-to-speech (TTS) provider. In MerClaw it
...
MerClaw posts to Inworld's streaming TTS endpoint, concatenates the
...
<Steps>
  ...
  <Step title="Send a message">
    Send a reply through any connected channel. MerClaw synthesizes the
...
<AccordionGroup>
  ...
  <Accordion title="Audio outputs">
    ...
    MerClaw asks Inworld for `OGG_OPUS` so the audio plays as a native

---
summary: "Use the Qwen Portal provider id with MerClaw"
read_when:
...
MerClaw has two Qwen-facing provider ids:
...
merclaw models set qwen/qwen3-coder-plus
```

...
title: "Together AI"
read_when:
  - You want to use Together AI with MerClaw
...
<Steps>
  ...
  <Step title="Run onboarding">
    ```bash
    merclaw onboard --auth-choice together-api-key
    ```
  </Step>
...
MerClaw ships this bundled Together catalog:
...
<AccordionGroup>
  <Accordion title="Environment note">
    ...
    gateway processes. Use `~/.merclaw/.env` or `env.shellEnv` config for
  ...
  <Accordion title="Troubleshooting">
    - Verify your key works: `merclaw models list --provider together`

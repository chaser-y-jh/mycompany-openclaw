...
[Tavily](https://tavily.com) is a search API designed for AI applications. MerClaw exposes it in two ways:
...
<Tip>
Choosing Tavily in onboarding or `merclaw configure --section web` enables the bundled Tavily plugin automatically.
</Tip>

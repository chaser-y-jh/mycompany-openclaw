...
MerClaw treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.merclaw/settings/voicewake.json`

Shape:

```json
{ "triggers": ["merclaw", "claude", "computer"], "updatedAtMs": 1730000000000 }
```

---
summary: "Contributor guide for adding a new shared capability to the MerClaw plugin system"
read_when:
...
<Info>
  This is a **contributor guide** for MerClaw core developers. If you are
...
Use this when MerClaw needs a new shared domain such as embeddings, image

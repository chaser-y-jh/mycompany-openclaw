---
summary: "Testing utilities and patterns for MerClaw plugins"
...
Reference for test utilities, patterns, and lint enforcement for MerClaw
plugins.
...
These test-helper subpaths are repo-local source entrypoints for MerClaw's own
...
**Plugin API mock import:** `merclaw/plugin-sdk/plugin-test-api`

**Agent runtime contract import:** `merclaw/plugin-sdk/agent-runtime-test-contracts`

**Channel contract import:** `merclaw/plugin-sdk/channel-contract-testing`

**Channel test helper import:** `merclaw/plugin-sdk/channel-test-helpers`

**Channel target test import:** `merclaw/plugin-sdk/channel-target-testing`

**Plugin contract import:** `merclaw/plugin-sdk/plugin-test-contracts`

**Plugin runtime test import:** `merclaw/plugin-sdk/plugin-test-runtime`

**Provider contract import:** `merclaw/plugin-sdk/provider-test-contracts`

**Provider HTTP mock import:** `merclaw/plugin-sdk/provider-http-test-mocks`

**Environment/network test import:** `merclaw/plugin-sdk/test-env`

**Generic fixture import:** `merclaw/plugin-sdk/test-fixtures`

**Node builtin mock import:** `merclaw/plugin-sdk/test-node-mocks`

Inside the MerClaw repo, prefer the focused subpaths below for new bundled
plugin tests. The broad
`merclaw/plugin-sdk/testing` barrel is legacy compatibility only.
...
import { installCommonResolveTargetErrorCases } from "merclaw/plugin-sdk/channel-target-testing";
import { AUTH_PROFILE_RUNTIME_CONTRACT } from "merclaw/plugin-sdk/agent-runtime-test-contracts";
...
import { createStartAccountContext } from "merclaw/plugin-sdk/channel-test-helpers";
...
import { getProviderHttpMocks } from "merclaw/plugin-sdk/provider-http-test-mocks";
import { withEnv, withFetchPreconnect, withServer } from "merclaw/plugin-sdk/test-env";
import {
  bundledPluginRoot,
  createCliRuntimeCapture,
  typedCases,
} from "merclaw/plugin-sdk/test-fixtures";
import { mockNodeBuiltinModule } from "merclaw/plugin-sdk/test-node-mocks";
```
...
suites that depend on bundled MerClaw inventory stay under `src/plugins/contracts`.
...
import type { MockFn, PluginRuntime, RuntimeEnv } from "merclaw/plugin-sdk/plugin-test-runtime";
```
...
MerClaw's loader acceptance gates. Add at least one loader-backed smoke test
...
Prefer the shared plugin runtime mock from `merclaw/plugin-sdk/channel-test-helpers`
...
import type { PluginRuntime } from "merclaw/plugin-sdk/runtime-store";
...
1. **No monolithic root imports** -- `merclaw/plugin-sdk` root barrel is rejected
...
MerClaw uses Vitest with V8 coverage thresholds. For plugin tests:

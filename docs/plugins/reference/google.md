---
summary: "Adds Google, Google Gemini CLI, Google Vertex model provider support to MerClaw."
read_when:
...
Adds Google, Google Gemini CLI, Google Vertex model provider support to MerClaw.

## Distribution

- Package: `@merclaw/google-plugin`

...
read_when:
  - Planning a broad MerClaw application modernization pass
...
modernization task. If adopting this guidance as a repo-local MerClaw skill,
create `.agents/skills/merclaw-frontend/SKILL.md` first, keep the frontmatter

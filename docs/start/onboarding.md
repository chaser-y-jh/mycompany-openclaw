---
summary: "First-run setup flow for MerClaw (macOS app)"
read_when:
...
- By default, MerClaw is a personal agent: one trusted operator boundary.
...
<Frame caption="Choose what permissions do you want to give MerClaw">
...
<Step title="CLI">
  ...
  The app can install the global `merclaw` CLI via npm, pnpm, or bun.

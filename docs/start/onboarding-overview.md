---
summary: "Overview of MerClaw onboarding options and flows"
read_when:
...
MerClaw has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `merclaw onboard`                     | Launch the app            |
...
CLI command docs: [`merclaw onboard`](/cli/onboard)

## macOS app onboarding

Open the MerClaw app. The first-run wizard walks you through the same steps

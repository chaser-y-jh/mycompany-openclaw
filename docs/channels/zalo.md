...
Zalo ships as a bundled plugin in current MerClaw releases, so normal packaged
...
- Install via CLI: `merclaw plugins install @merclaw/zalo`
- Pinned version: `merclaw plugins install @merclaw/zalo@2026.5.2`
- Or from a source checkout: `merclaw plugins install ./path/to/local/zalo-plugin`
...
This page reflects current MerClaw behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `merclaw pairing list zalo`
  - `merclaw pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in MerClaw.
...
- Example: `merclaw message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `merclaw channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `merclaw logs --follow`

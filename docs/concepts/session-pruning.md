...
MerClaw also builds a separate idempotent replay view for sessions that
...
MerClaw auto-enables pruning for Anthropic profiles:
...
If you set explicit values, MerClaw does not override them.

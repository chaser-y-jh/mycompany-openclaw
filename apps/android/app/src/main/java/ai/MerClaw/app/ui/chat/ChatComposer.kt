...
import ai.merclaw.app.ui.mobileAccentBorderStrong
...
import ai.merclaw.app.ui.mobileHeadline
import ai.merclaw.app.ui.mobileSurface
import ai.merclaw.app.ui.mobileText
import ai.merclaw.app.ui.mobileTextSecondary
import ai.merclaw.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.merclaw.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.merclaw.app.ui.mobileFontFamily,

...
import ai.merclaw.app.SecurePrefs
import ai.merclaw.app.VoiceWakeMode
import ai.merclaw.app.gateway.GatewayClientInfo
import ai.merclaw.app.gateway.GatewayConnectOptions
import ai.merclaw.app.gateway.GatewayEndpoint
import ai.merclaw.app.gateway.GatewayTlsParams
import ai.merclaw.app.gateway.isLocalCleartextGatewayHost
import ai.merclaw.app.gateway.isLoopbackGatewayHost
...
class ConnectionManager(
  ...
  fun buildUserAgent(): String {
    ...
    return "MerClawAndroid/$version (Android $releaseLabel; SDK ${Build.VERSION.SDK_INT})"
  }
  ...
  fun buildNodeConnectOptions(): GatewayConnectOptions =
    GatewayConnectOptions(
      ...
      client = buildClientInfo(clientId = "merclaw-android", clientMode = "node"),
  ...
  fun buildOperatorConnectOptions(): GatewayConnectOptions =
    GatewayConnectOptions(
      ...
      commands = emptyList(),
      permissions = emptyMap(),
      client = buildClientInfo(clientId = "merclaw-android", clientMode = "ui"),
      userAgent = buildUserAgent(),
    )

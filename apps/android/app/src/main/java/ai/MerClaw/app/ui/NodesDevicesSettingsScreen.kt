...
import ai.merclaw.app.GatewayDeviceTokenSummary
import ai.merclaw.app.GatewayNodeSummary
import ai.merclaw.app.GatewayNodesDevicesSummary
import ai.merclaw.app.GatewayPairedDeviceSummary
import ai.merclaw.app.GatewayPendingDeviceSummary
...
private fun nodeSubtitle(node: GatewayNodeSummary): String {
  ...
  val version = node.version?.let { "MerClaw $it" }

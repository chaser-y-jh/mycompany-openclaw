...
import ai.merclaw.app.NotificationBurstLimiter
import ai.merclaw.app.SecurePrefs
import ai.merclaw.app.allowsPackage
import ai.merclaw.app.isWithinQuietHours
...
class DeviceNotificationListenerService : NotificationListenerService() {
  ...
  companion object {
    ...
    private fun recentPackagesPrefs(context: Context) = context.applicationContext.getSharedPreferences("merclaw.secure", Context.MODE_PRIVATE)

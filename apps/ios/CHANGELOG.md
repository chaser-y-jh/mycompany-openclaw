# MerClaw iOS Changelog

## 2026.5.31 - 2026-05-31

Maintenance update for the current MerClaw release.
...
Maintenance update for the current MerClaw beta release.
...
Maintenance update for the current MerClaw development release.
...
First App Store release of MerClaw for iPhone. Pair with your MerClaw Gateway to use chat, voice, sharing, and device actions from iOS.

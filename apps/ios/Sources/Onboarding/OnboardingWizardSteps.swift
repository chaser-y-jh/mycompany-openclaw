...
struct OnboardingIntroStep: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            Text("Turn this iPhone into a secure MerClaw node for chat, voice, camera, and device tools.")
                .font(.subheadline)
            ...
            VStack(alignment: .leading, spacing: 14) {
                ...
                Label("Use MerClaw from your phone", systemImage: "message.fill")
            }
            ...
            HStack(alignment: .top, spacing: 12) {
                ...
                VStack(alignment: .leading, spacing: 6) {
                    Text("Security notice")
                        .font(.headline)
                    Text(
                        "The connected MerClaw agent can use device capabilities you enable, "
...
struct OnboardingWelcomeStep: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            Text("Scan a QR code from your MerClaw gateway or continue with manual setup.")
                .font(.subheadline)
                .foregroundStyle(.secondary)
                .multilineTextAlignment(.center)
                .padding(.horizontal, 32)

...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: MerClawPhotosLatestParams) async throws -> MerClawPhotosLatestPayload {
        ...
        var results: [MerClawPhotoPayload] = []
        ...
        return MerClawPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> MerClawPhotoPayload
    {

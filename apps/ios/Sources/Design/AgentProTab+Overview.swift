...
extension AgentProTab {
    ...
    func agentRow(_ agent: AgentSummary) -> some View {
        ...
        return HStack(alignment: .top, spacing: 12) {
            ...
            .buttonStyle(.plain)
            .foregroundStyle(isActive ? MerClawBrand.accent : .primary)
    ...
    var instancesColor: Color {
        ...
        return (self.overview?.presence.isEmpty == false) ? MerClawBrand.accent : .secondary
    }
    ...
    var cronColor: Color {
        guard self.gatewayConnected else { return .secondary }
        return self.overview?.cronStatus?.enabled == true ? MerClawBrand.accent : .secondary
    }
    ...
    var dreamingColor: Color {
        guard self.gatewayConnected else { return .secondary }
        return self.overview?.dreaming?.enabled == true ? MerClawBrand.accent : .secondary
    }

...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.merclaw.gateway"
    private static let nodeService = "ai.merclaw.node"
    private static let talkService = "ai.merclaw.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.merclaw.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.merclaw.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("merclaw-gateway.log")
    }

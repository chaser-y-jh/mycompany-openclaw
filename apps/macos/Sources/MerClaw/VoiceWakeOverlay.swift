...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.merclaw", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other MerClaw windows, but below the system’s pop-up menus.

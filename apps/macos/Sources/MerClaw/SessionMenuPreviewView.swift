...
enum SessionMenuPreviewLoader {
    private static let logger = Logger(subsystem: "ai.merclaw", category: "SessionPreview")
    ...
    private static func requestPreview(
        keys: [String],
        maxItems: Int) async throws -> MerClawSessionsPreviewPayload
    {
    ...
    private static func snapshot(
        from entry: MerClawSessionPreviewEntry,
    ...
    private static func cache(payload: MerClawSessionsPreviewPayload, maxItems: Int) async {
    ...
    private static func previewItems(
        from payload: MerClawChatHistoryPayload,
        maxItems: Int) -> [SessionPreviewItem]
    {
        let boundedItems = self.normalizeMaxItems(maxItems)
        let raw: [MerClawKit.AnyCodable] = payload.messages ?? []
    ...
    private static func decodeMessages(_ raw: [MerClawKit.AnyCodable]) -> [MerClawChatMessage] {
    ...
    private static func previewText(for message: MerClawChatMessage) -> String? {
    ...
    private static func isToolCall(_ message: MerClawChatMessage) -> Bool {
    ...
    private static func toolNames(for message: MerClawChatMessage) -> [String] {
        var names: [String] = []
    ...
    private static func mediaSummary(for message: MerClawChatMessage) -> String? {

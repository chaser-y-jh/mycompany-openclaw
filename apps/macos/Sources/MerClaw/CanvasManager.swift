...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.merclaw", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("MerClaw/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__merclaw__/a2ui/").absoluteString + "?platform=macos"
    }

...
enum MerClawConfigFile {
    private static let logger = Logger(subsystem: "ai.merclaw", category: "config")
    ...
    static func url() -> URL {
        MerClawPaths.configURL
    }

    static func stateDirURL() -> URL {
        MerClawPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        MerClawPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-merclaw-config-file",
            "event": "config.write",

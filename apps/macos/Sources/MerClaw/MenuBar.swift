...
struct MerClawApp: App {
    ...
    private static let logger = Logger(subsystem: "ai.merclaw", category: "app")
    ...
    var body: some Scene {
        ...
        Window("MerClaw Settings", id: SettingsWindowOpener.windowID) {
    ...
    private func applyStatusItemAppearance(paused _: Bool, sleeping _: Bool) {
        ...
        self.statusItem?.button?.toolTip = self.state.voiceWakeMeterActive
            ? "MerClaw - Voice Wake live meter active"
            : "MerClaw"
    }
...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private let webChatAutoLogger = Logger(subsystem: "ai.merclaw", category: "Chat")

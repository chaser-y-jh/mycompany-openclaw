...
final class CLIInstallPrompter {
    ...
    private let logger = Logger(subsystem: "ai.merclaw", category: "cli.prompt")
    ...
    func checkAndPromptIfNeeded(reason: String) {
        ...
        let alert = NSAlert()
        alert.messageText = "Install MerClaw CLI?"
    ...
    private func openSettings(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .merclawSelectSettingsTab, object: tab)
        }
    }

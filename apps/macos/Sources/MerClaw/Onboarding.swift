...
enum UIStrings {
    static let welcomeTitle = "Welcome to MerClaw"
}
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: MerClawChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g merclaw@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: MerClawChatViewModel(

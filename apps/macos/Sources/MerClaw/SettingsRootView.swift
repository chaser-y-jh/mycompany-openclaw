...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .merclawSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? MerClawPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? MerClawPaths.stateDirURL.path
...
private struct SettingsTabGroup: Identifiable {
    ...
    static func defaultGroups(showDebug: Bool) -> [SettingsTabGroup] {
        var groups = [
            ...
            SettingsTabGroup(title: "MerClaw", tabs: [.about]),
        ]
...
extension Notification.Name {
    static let merclawSelectSettingsTab = Notification.Name("merclawSelectSettingsTab")
}

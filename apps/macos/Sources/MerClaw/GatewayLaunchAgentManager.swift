...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.merclaw", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".merclaw/disable-launchagent"
...
extension GatewayLaunchAgentManager {
        ...
        quiet: Bool) async -> CommandResult
    {
        ...
        #endif
        let command = CommandResolver.merclawCommand(
            subcommand: "gateway",

...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/merclaw/merclaw") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/merclaw/merclaw")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://merclaw.ai")
            ...
            Text("© 2026 MerClaw Foundation — MIT License.")
                .font(.footnote)
                .foregroundStyle(.secondary)
                .padding(.top, 4)
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "MerClawBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "MerClawBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "MerClawGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "MerClawGitCommit") as? String) ??
            "unknown"
    }

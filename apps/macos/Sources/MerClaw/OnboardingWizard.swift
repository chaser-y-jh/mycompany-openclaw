...
private let onboardingWizardLogger = Logger(subsystem: "ai.merclaw", category: "onboarding.wizard")

// MARK: - Swift 6 AnyCodable Bridging Helpers

// Bridge between MerClawProtocol.AnyCodable and the local module to avoid
// Swift 6 strict concurrency type conflicts.

private typealias ProtocolAnyCodable = MerClawProtocol.AnyCodable

...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.merclaw", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return MerClawConfigFile.defaultWorkspaceURL() }

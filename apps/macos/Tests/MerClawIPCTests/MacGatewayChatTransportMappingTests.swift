...
struct MacGatewayChatTransportMappingTests {
    @Test func `snapshot maps to health`() {
        let snapshot = Snapshot(
            presence: [],
            health: MerClawProtocol.AnyCodable(["ok": MerClawProtocol.AnyCodable(false)]),
    ...
    @Test func `health event maps to health`() {
        let frame = EventFrame(
            type: "event",
            event: "health",
            payload: MerClawProtocol.AnyCodable(["ok": MerClawProtocol.AnyCodable(true)]),
            seq: 1,
            stateversion: nil)
    ...
    @Test func `chat event maps to chat`() {
        let payload = MerClawProtocol.AnyCodable([
            "runId": MerClawProtocol.AnyCodable("run-1"),
            "sessionKey": MerClawProtocol.AnyCodable("main"),
            "state": MerClawProtocol.AnyCodable("final"),
        ])
    ...
    @Test func `session message event maps to session message`() {
        let payload = MerClawProtocol.AnyCodable([
            "sessionKey": MerClawProtocol.AnyCodable("agent:main:main"),
            "messageId": MerClawProtocol.AnyCodable("msg-1"),
            "messageSeq": MerClawProtocol.AnyCodable(7),
            "message": MerClawProtocol.AnyCodable([
                "role": MerClawProtocol.AnyCodable("user"),
                "content": MerClawProtocol.AnyCodable([
                    MerClawProtocol.AnyCodable([
                        "type": MerClawProtocol.AnyCodable("text"),
                        "text": MerClawProtocol.AnyCodable("spoken transcript"),
                    ]),
                ]),
                "timestamp": MerClawProtocol.AnyCodable(1234.5),
            ]),
        ])
    ...
    @Test func `unknown event maps to nil`() {
        let frame = EventFrame(
            type: "event",
            event: "unknown",
            payload: MerClawProtocol.AnyCodable(["a": MerClawProtocol.AnyCodable(1)]),
            seq: 1,
            stateversion: nil)
        let mapped = MacGatewayChatTransport.mapPushToTransportEvent(.event(frame))
        #expect(mapped == nil)

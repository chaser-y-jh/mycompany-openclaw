...
private struct AttachmentProcessingTransport: MerClawChatTransport {
    func requestHistory(sessionKey _: String) async throws -> MerClawChatHistoryPayload {
...
final class ChatViewModelAttachmentTests: XCTestCase {
    func testImageAttachmentsAreProcessedBeforeStaging() async throws {
        ...
        let viewModel = await MainActor.run {
            MerClawChatViewModel(sessionKey: "main", transport: AttachmentProcessingTransport())
        }

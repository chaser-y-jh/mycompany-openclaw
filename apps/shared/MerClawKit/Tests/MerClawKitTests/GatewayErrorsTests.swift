...
@Suite struct GatewayErrorsTests {
    ...
    @Test func connectAuthErrorPreservesStructuredMetadata() {
        let error = GatewayConnectAuthError(
            ...
            actionCommand: "merclaw devices approve req-123",
            docsURLString: "https://docs.merclaw.ai/gateway/pairing",
        ...
        #expect(error.actionCommand == "merclaw devices approve req-123")
        #expect(error.docsURLString == "https://docs.merclaw.ai/gateway/pairing")
    ...
    @Test func pairingProblemUsesStructuredRequestMetadata() {
        ...
        #expect(problem?.actionCommand == "merclaw devices approve req-123")
    }

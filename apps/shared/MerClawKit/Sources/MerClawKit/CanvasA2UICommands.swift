...
public enum MerClawCanvasA2UICommand: String, Codable, Sendable {
...
public struct MerClawCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct MerClawCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {

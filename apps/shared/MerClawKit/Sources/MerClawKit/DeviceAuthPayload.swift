...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: MerClawProtocol.AnyCodable]?
    {
        ...
        return [
            "id": MerClawProtocol.AnyCodable(identity.deviceId),
            "publicKey": MerClawProtocol.AnyCodable(publicKey),
            "signature": MerClawProtocol.AnyCodable(signature),
            "signedAt": MerClawProtocol.AnyCodable(signedAtMs),
            "nonce": MerClawProtocol.AnyCodable(nonce),
        ]
    }
}

...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.merclaw", category: "node.gateway")
    ...
    {
        let timeoutLogger = Logger(subsystem: "ai.merclaw", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: MerClawProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {

...
public enum MerClawTalkCommand: String, Codable, Sendable {
...
public struct MerClawTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct MerClawTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String

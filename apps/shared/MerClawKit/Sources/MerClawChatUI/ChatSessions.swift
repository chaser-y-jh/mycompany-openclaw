...
public struct MerClawChatThinkingLevelOption: Codable, Identifiable, Sendable, Hashable {
...
public struct MerClawChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct MerClawChatSessionsDefaults: Codable, Sendable {
    public let modelProvider: String?
    public let model: String?
    public let contextTokens: Int?
    public let thinkingLevels: [MerClawChatThinkingLevelOption]?
    ...
    public init(
        ...
        model: String?,
        contextTokens: Int?,
        thinkingLevels: [MerClawChatThinkingLevelOption]? = nil,
...
public struct MerClawChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
    public var id: String {
        self.key
    }
...
public struct MerClawChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: MerClawChatSessionsDefaults?
    public let sessions: [MerClawChatSessionEntry]
    ...
    public init(
        ...
        sessions: [MerClawChatSessionEntry])
    {
        self.ts = ts
        self.path = path
        self.count = count

...
public typealias MerClawPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias MerClawPlatformImage = UIImage
#endif

public struct MerClawChatUsageCost: Codable, Hashable, Sendable {
...
public struct MerClawChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: MerClawChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(MerClawChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct MerClawChatMessageContent: Codable, Hashable, Sendable {
...
public struct MerClawChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [MerClawChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: MerClawChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [MerClawChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: MerClawChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        let decodedUsage = try container.decodeIfPresent(MerClawChatUsage.self, forKey: .usage)
        ...
        if let decoded = try? container.decode([MerClawChatMessageContent].self, forKey: .content) {
...
public struct MerClawChatHistoryPayload: Codable, Sendable {
...
public struct MerClawSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct MerClawSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [MerClawSessionPreviewItem]
}

public struct MerClawSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [MerClawSessionPreviewEntry]

    public init(ts: Int, previews: [MerClawSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct MerClawChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct MerClawChatCreateSessionResponse: Codable, Sendable {
    public let ok: Bool?
    public let key: String
    public let sessionId: String?
}

public struct MerClawChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct MerClawSessionMessageEventPayload: Codable, Sendable {
    public let sessionKey: String?
    public let message: MerClawChatMessage?
...
public struct MerClawAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct MerClawChatPendingToolCall: Identifiable, Hashable, Sendable {
    public var id: String {
        self.toolCallId
    }
...
public struct MerClawGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct MerClawPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: MerClawPlatformImage?
...
public struct MerClawChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String

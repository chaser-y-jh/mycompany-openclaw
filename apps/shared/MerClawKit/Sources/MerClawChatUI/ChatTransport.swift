...
public enum MerClawChatTransportEvent: Sendable {
    case health(ok: Bool)
    case tick
    case chat(MerClawChatEventPayload)
    case sessionMessage(MerClawSessionMessageEventPayload)
    case agent(MerClawAgentEventPayload)
    case seqGap
}

public protocol MerClawChatTransport: Sendable {
    func createSession(
        key: String,
        label: String?,
...
extension MerClawChatTransport {
    public func createSession(
        key _: String,
        label _: String?,
        parentSessionKey _: String?) async throws -> MerClawChatCreateSessionResponse
    {
        throw NSError(
    ...
    public func listSessions(limit _: Int?) async throws -> MerClawChatSessionsListResponse {
        throw NSError(
            domain: "MerClawChatTransport",
            code: 0,
    ...
    public func listModels() async throws -> [MerClawChatModelChoice] {
        throw NSError(
            domain: "MerClawChatTransport",
            code: 0,

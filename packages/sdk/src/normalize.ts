import type { GatewayEvent, JsonObject, MerClawEvent, MerClawEventType } from "./types.js";
...
function normalizeLifecycleEndEventType(data: JsonObject): MerClawEventType {
...
function normalizeAgentEventType(payload: JsonObject): MerClawEventType {
...
function normalizeNamedEventType(event: GatewayEvent): MerClawEventType {
...
export function normalizeGatewayEvent(event: GatewayEvent): MerClawEvent {
  const payload = asRecord(event.payload);

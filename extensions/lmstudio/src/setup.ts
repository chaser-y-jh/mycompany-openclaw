...
import { withAgentModelAliases } from "merclaw/plugin-sdk/provider-onboard";
import {
...
function stripLmstudioStoredAuthConfig(cfg: MerClawConfig): MerClawConfig {
...
function mergeDiscoveredLmstudioAllowlistEntries(params: {
  existing?: NonNullable<NonNullable<MerClawConfig["agents"]>["defaults"]>["models"];
  discoveredModels: ModelDefinitionConfig[];
}) {

...
function createApi(params?: {
  pluginConfig?: MerClawPluginApi["pluginConfig"];
  registerHttpRoute?: MerClawPluginApi["registerHttpRoute"];
  logger?: MerClawPluginApi["logger"];
}): MerClawPluginApi {
...
function requireFirstRouteRegistration(mock: ReturnType<typeof vi.fn>) {
  ...
  return call[0] as Parameters<MerClawPluginApi["registerHttpRoute"]>[0];
}

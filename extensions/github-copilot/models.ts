...
import { buildCopilotIdeHeaders, COPILOT_INTEGRATION_ID } from "merclaw/plugin-sdk/provider-auth";
...
import { normalizeModelCompat } from "merclaw/plugin-sdk/provider-model-shared";
import {
...
export function resolveCopilotForwardCompatModel(
  ...
  // by simply adding them to agents.defaults.models in merclaw.json — no

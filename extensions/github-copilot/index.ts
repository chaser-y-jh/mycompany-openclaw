...
import { getCachedLiveCatalogValue } from "merclaw/plugin-sdk/provider-catalog-shared";
...
function applyCopilotDefaultModel(cfg: MerClawConfig): MerClawConfig {
...
export default definePluginEntry({
  ...
  register(api) {
    ...
    function resolveCurrentPluginConfig(config?: MerClawConfig): GithubCopilotPluginConfig {

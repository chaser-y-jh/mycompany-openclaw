import type { OutputRuntimeEnv } from "merclaw/plugin-sdk/runtime";
import type { ChannelSetupWizardAdapter } from "merclaw/plugin-sdk/setup";
...
export function createMatrixUpdateKeepCredentialsPrompter(params?: {
  ...
  return createMatrixWizardPrompter({
    ...
    text: {
      ...
      "Matrix device name (optional)": params?.deviceName ?? "MerClaw Gateway",
    },
    confirm: {

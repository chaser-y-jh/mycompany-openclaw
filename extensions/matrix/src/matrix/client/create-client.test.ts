...
describe("createMatrixClient", () => {
  const storagePaths = {
    rootDir: "/tmp/merclaw-matrix-create-client-test",
    storagePath: "/tmp/merclaw-matrix-create-client-test/storage.json",
    recoveryKeyPath: "/tmp/merclaw-matrix-create-client-test/recovery.key",
    idbSnapshotPath: "/tmp/merclaw-matrix-create-client-test/idb.snapshot",
    metaPath: "/tmp/merclaw-matrix-create-client-test/storage-meta.json",
    accountKey: "default",
  ...
  it("persists storage metadata by default", async () => {
    ...
    expect(MatrixClientMock).toHaveBeenCalledWith("https://matrix.example.org", "tok", {
      ...
      cryptoDatabasePrefix: "merclaw-matrix-default-token-hash",

import type { MerClawPluginApi as MatrixEntryPluginApi } from "merclaw/plugin-sdk/channel-entry-contract";
import {
...
vi.mock("merclaw/plugin-sdk/conversation-binding-runtime", () => ({

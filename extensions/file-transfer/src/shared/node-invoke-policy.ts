...
type PreflightResult =
  ...
  | {
      ok: false;
      result: MerClawPluginNodeInvokePolicyResult;
    };
...
async function handleFileTransferInvoke(
  ctx: MerClawPluginNodeInvokePolicyContext,
): Promise<MerClawPluginNodeInvokePolicyResult> {
...
export function createFileTransferNodeInvokePolicy(): MerClawPluginNodeInvokePolicy {
  return {

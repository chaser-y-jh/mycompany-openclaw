...
// without touching ~/.merclaw/merclaw.json.
...
vi.mock("merclaw/plugin-sdk/config-mutation", () => ({
...
afterAll(() => {
  vi.doUnmock("merclaw/plugin-sdk/runtime-config-snapshot");
  vi.doUnmock("merclaw/plugin-sdk/config-mutation");
  vi.resetModules();
});

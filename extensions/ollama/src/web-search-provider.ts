...
import { resolveEnvApiKey } from "merclaw/plugin-sdk/provider-auth-runtime";
import {
...
function resolveConfiguredOllamaWebSearchApiKey(config?: MerClawConfig): string | undefined {
...
function resolveOllamaWebSearchApiKey(config?: MerClawConfig): string | undefined {
  return resolveConfiguredOllamaWebSearchApiKey(config) ?? resolveEnvOllamaWebSearchApiKey();
}

function resolveOllamaWebSearchBaseUrl(config?: MerClawConfig): string {

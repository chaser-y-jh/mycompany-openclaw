...
function mergeZaloAccountConfig(cfg: MerClawConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: MerClawConfig): ResolvedZaloAccount[] {

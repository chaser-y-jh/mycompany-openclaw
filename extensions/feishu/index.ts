...
function registerFeishuDocTools(api: MerClawPluginApi) {
...
function registerFeishuChatTools(api: MerClawPluginApi) {
  const register = loadBundledEntryExportSync<(api: MerClawPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",
...
function registerFeishuWikiTools(api: MerClawPluginApi) {
  const register = loadBundledEntryExportSync<(api: MerClawPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",
...
function registerFeishuDriveTools(api: MerClawPluginApi) {
  const register = loadBundledEntryExportSync<(api: MerClawPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",
...
function registerFeishuPermTools(api: MerClawPluginApi) {
  const register = loadBundledEntryExportSync<(api: MerClawPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",
...
function registerFeishuBitableTools(api: MerClawPluginApi) {
  const register = loadBundledEntryExportSync<(api: MerClawPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",

...
Read-only diff viewer plugin for **MerClaw** agents.

## Install

```bash
merclaw plugins install @merclaw/diffs
```
...
- https://docs.merclaw.ai/tools/diffs

## Package

- Plugin id: `diffs`
- Package: `@merclaw/diffs`
- Minimum MerClaw host: `2026.4.30`
...
Before:
MerClaw supports plugins.

After:
MerClaw supports plugins and hosted diff views.
```
...
- Artifacts are ephemeral and stored in the plugin temp subfolder (`$TMPDIR/merclaw-diffs`).

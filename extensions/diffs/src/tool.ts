...
import { optionalFiniteNumberSchema, stringEnum } from "merclaw/plugin-sdk/channel-actions";
...
import type { AnyAgentTool, MerClawPluginApi, MerClawPluginToolContext } from "../api.js";
...
function buildArtifactContext(
  context: MerClawPluginToolContext | undefined,

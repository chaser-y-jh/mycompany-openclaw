...
import { mapPluginConfigIssues } from "merclaw/plugin-sdk/extension-shared";
import { buildPluginConfigSchema, z, type MerClawPluginConfigSchema } from "../api.js";
...
export const memoryWikiConfigSchema: MerClawPluginConfigSchema = memoryWikiConfigSchemaBase;
...
export function resolveDefaultMemoryWikiVaultPath(homedir = os.homedir()): string {
  return path.join(homedir, ".merclaw", "wiki", "main");
}

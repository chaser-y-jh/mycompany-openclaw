...
import { wrapToolWithBeforeToolCallHook } from "merclaw/plugin-sdk/agent-harness-runtime";
import {
...
describe("MerClaw-owned tool runtime contract — Codex app-server adapter", () => {
  afterEach(() => {
    resetMerClawOwnedToolHooks();
  });

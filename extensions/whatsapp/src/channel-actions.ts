...
function areWhatsAppAgentReactionsEnabled(params: { cfg: MerClawConfig; accountId?: string }) {
...
function hasAnyWhatsAppAccountWithAgentReactionsEnabled(cfg: MerClawConfig) {

...
import { buildApprovalReactionPromptPayloadForRequest } from "merclaw/plugin-sdk/approval-reaction-runtime";
import type {
  ExecApprovalRequest,
...
type ApprovalForwardingConfig = NonNullable<NonNullable<MerClawConfig["approvals"]>["exec"]>;

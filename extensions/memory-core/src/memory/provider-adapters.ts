...
import { resolveUserPath } from "merclaw/plugin-sdk/memory-core-host-engine-foundation";
import { getProviderEnvVars } from "merclaw/plugin-sdk/provider-env-vars";
...
function formatLocalSetupError(err: unknown): string {
  ...
  return [
    ...
    missing
      ? `2) Install ${NODE_LLAMA_CPP_RUNTIME_PACKAGE} next to the MerClaw package or source checkout`
      : null,

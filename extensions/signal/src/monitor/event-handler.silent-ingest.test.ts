...
vi.mock("merclaw/plugin-sdk/hook-runtime", async () => {
  const actual = await vi.importActual<typeof import("merclaw/plugin-sdk/hook-runtime")>(
    "merclaw/plugin-sdk/hook-runtime",
  );
  return {
    ...actual,

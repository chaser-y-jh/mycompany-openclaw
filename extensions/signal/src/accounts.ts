...
function mergeSignalAccountConfig(cfg: MerClawConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: MerClawConfig): ResolvedSignalAccount[] {

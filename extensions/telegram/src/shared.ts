import { resolveNormalizedAccountEntry } from "merclaw/plugin-sdk/account-core";
...
import { createChannelPluginBase, type ChannelPlugin } from "merclaw/plugin-sdk/channel-core";
import { getChatChannelMeta } from "merclaw/plugin-sdk/channel-plugin-common";
import type { MerClawConfig, TelegramAccountConfig } from "merclaw/plugin-sdk/config-contracts";
 ...
 *
 * See: https://github.com/merclaw/merclaw/issues/53876
 */
function isBlockedByMultiBotGuard(cfg: MerClawConfig, accountId: string): boolean {

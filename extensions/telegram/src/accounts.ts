...
import { formatSetExplicitDefaultInstruction } from "merclaw/plugin-sdk/routing";
import { createSubsystemLogger, isTruthyEnvValue } from "merclaw/plugin-sdk/runtime-env";
...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.MERCLAW_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listEnabledTelegramAccounts(cfg: MerClawConfig): ResolvedTelegramAccount[] {

import { resolveApprovalApprovers } from "merclaw/plugin-sdk/approval-auth-runtime";
import {
...
import { resolveApprovalRequestChannelAccountId } from "merclaw/plugin-sdk/approval-native-runtime";
import type {
  ExecApprovalRequest,
  PluginApprovalRequest,
} from "merclaw/plugin-sdk/approval-runtime";
import type { MerClawConfig } from "merclaw/plugin-sdk/config-contracts";
import type { TelegramExecApprovalConfig } from "merclaw/plugin-sdk/config-contracts";
...
function resolveTelegramOwnerApprovers(cfg: MerClawConfig): Array<string | number> {

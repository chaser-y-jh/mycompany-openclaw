...
Official Google Meet participant plugin for MerClaw.
...
```bash
merclaw plugins install @merclaw/google-meet
```
...
- https://docs.merclaw.ai/plugins/google-meet
...
- Minimum MerClaw host: `2026.4.20`

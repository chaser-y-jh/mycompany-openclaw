...
Nostr DM channel plugin for MerClaw using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to MerClaw. It enables your bot to:
...
# Configure merclaw to use local relay

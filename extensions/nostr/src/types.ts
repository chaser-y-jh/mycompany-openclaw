...
import { normalizeSecretInputString, type SecretInput } from "merclaw/plugin-sdk/secret-input";
...
function resolveConfiguredDefaultNostrAccountId(cfg: MerClawConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: MerClawConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: MerClawConfig): string {

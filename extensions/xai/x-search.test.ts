                ...
                content: [
                  {
                    type: "output_text",
                    text: "Found X posts",
                    annotations: [{ type: "url_citation", url: "https://x.com/merclaw/status/1" }],
                  },
                ],
              },
            ],
            citations: ["https://x.com/merclaw/status/1"],
          },
        ),
    } as Response),
  );

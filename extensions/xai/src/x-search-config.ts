...
function resolveLegacyXSearchConfig(config?: MerClawConfig): JsonRecord | undefined {
...
function resolvePluginXSearchConfig(config?: MerClawConfig): JsonRecord | undefined {
...
function resolveLegacyGrokWebSearchConfig(config?: MerClawConfig): JsonRecord | undefined {
  const web = config?.tools?.web as Record<string, unknown> | undefined;
...
function resolvePluginWebSearchConfig(config?: MerClawConfig): JsonRecord | undefined {
  const pluginConfig = config?.plugins?.entries?.xai?.config;
...
export function resolveEffectiveXSearchConfig(config?: MerClawConfig): JsonRecord | undefined {

import { stringEnum } from "merclaw/plugin-sdk/channel-actions";
import type { AnyAgentTool, MerClawPluginToolContext } from "merclaw/plugin-sdk/core";
...
type ZalouserToolContext = Pick<MerClawPluginToolContext, "deliveryContext">;

...
function mergeZalouserAccountConfig(cfg: MerClawConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: MerClawConfig; accountId?: string | null }) {

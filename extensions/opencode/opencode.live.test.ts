...
import { extractNonEmptyAssistantText, isLiveTestEnabled } from "merclaw/plugin-sdk/test-env";
...
const LIVE_MODEL_ID =
  process.env.MERCLAW_LIVE_OPENCODE_DEEPSEEK_MODEL?.trim() || "deepseek-v4-flash-free";

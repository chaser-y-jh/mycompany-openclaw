import type { MerClawConfig as RuntimeApiMerClawConfig } from "merclaw/plugin-sdk/config-contracts";
...
export type IMessageAccountConfig = Omit<
  NonNullable<NonNullable<RuntimeApiMerClawConfig["channels"]>["imessage"]>,

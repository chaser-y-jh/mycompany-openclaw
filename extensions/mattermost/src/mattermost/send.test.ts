import { expectProvidedCfgSkipsRuntimeLoad } from "merclaw/plugin-sdk/channel-test-helpers";
...
vi.mock("merclaw/plugin-sdk/plugin-config-runtime", () => ({
...
vi.mock("merclaw/plugin-sdk/text-chunking", () => ({

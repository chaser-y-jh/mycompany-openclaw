...
// steer MerClaw-managed Claude CLI runs toward a different provider,
...
function isMerClawRequestedYolo(context?: CliBackendNormalizeConfigContext): boolean {
...
export function resolveClaudePermissionMode(context?: CliBackendNormalizeConfigContext): {
  ...
  return isMerClawRequestedYolo(context)

...
type AgentDefaultsModel = NonNullable<NonNullable<MerClawConfig["agents"]>["defaults"]>["model"];
type AgentDefaultsModels = NonNullable<NonNullable<MerClawConfig["agents"]>["defaults"]>["models"];

/**
 * Voice call response generator - uses the embedded MerClaw agent for tool support.
...
/**
 * Generate a voice response using the embedded MerClaw agent with full tool support.

...
import { loadWebMediaRaw } from "merclaw/plugin-sdk/web-media";
import { afterAll, afterEach, beforeAll, beforeEach, describe, expect, it, vi } from "vitest";
import { RateLimitError } from "./internal/discord.js";
import { makeDiscordRest } from "./send.test-harness.js";

vi.mock("merclaw/plugin-sdk/web-media", async () => {
...
afterAll(() => {
  vi.doUnmock("merclaw/plugin-sdk/web-media");
});
...
describe("uploadStickerDiscord", () => {
  ...
  it("uploads sticker assets", async () => {
    ...
    expect(stickerBody.name).toBe("merclaw_wave");
    expect(stickerBody.description).toBe("MerClaw waving");

...
import type { DiscordAccountConfig, DiscordActionConfig, MerClawConfig } from "./runtime-api.js";
...
export function listEnabledDiscordAccounts(cfg: MerClawConfig): ResolvedDiscordAccount[] {

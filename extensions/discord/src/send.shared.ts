...
import { buildOutboundMediaLoadOptions } from "merclaw/plugin-sdk/media-runtime";
import { extensionForMime } from "merclaw/plugin-sdk/media-runtime";
import {
...
import type { ChunkMode } from "merclaw/plugin-sdk/reply-chunking";
import { resolveTextChunksWithFallback } from "merclaw/plugin-sdk/reply-payload";
import type { RetryRunner } from "merclaw/plugin-sdk/retry-runtime";
...
async function resolveDiscordTargetChannelId(
  raw: string,
  opts: DiscordClientOpts & { cfg: MerClawConfig },
): Promise<{ channelId: string; dm?: boolean }> {

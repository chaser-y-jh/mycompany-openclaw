import { buildMessagingTarget, type MessagingTarget } from "merclaw/plugin-sdk/channel-targets";
import type { DirectoryConfigParams } from "merclaw/plugin-sdk/directory-runtime";

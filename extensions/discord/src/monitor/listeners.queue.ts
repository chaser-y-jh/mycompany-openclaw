import { createSubsystemLogger, formatDurationSeconds } from "merclaw/plugin-sdk/runtime-env";

export type DiscordListenerLogger = ReturnType<
  typeof import("merclaw/plugin-sdk/runtime-env").createSubsystemLogger
>;

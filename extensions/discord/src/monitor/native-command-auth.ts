import { resolveCommandAuthorizedFromAuthorizers } from "merclaw/plugin-sdk/command-auth-native";
...
export function resolveDiscordCommandOwnerAllowFrom(cfg: MerClawConfig): string[] | undefined {

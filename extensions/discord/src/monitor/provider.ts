...
import { createConnectedChannelStatusPatch } from "merclaw/plugin-sdk/gateway-runtime";
import {
...
import { isVerbose, logVerbose, shouldLogVerbose, warn } from "merclaw/plugin-sdk/runtime-env";
import { createSubsystemLogger } from "merclaw/plugin-sdk/runtime-env";
import { createNonExitingRuntime, type RuntimeEnv } from "merclaw/plugin-sdk/runtime-env";
import {
...
export async function monitorDiscordProvider(opts: MonitorDiscordOpts = {}) {
  ...
  try {
    ...
    const guildHistories = new Map<
      string,
      import("merclaw/plugin-sdk/reply-history").HistoryEntry[]
    >();

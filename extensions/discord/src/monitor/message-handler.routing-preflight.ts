...
let conversationRuntimePromise:
  | Promise<typeof import("merclaw/plugin-sdk/conversation-binding-runtime")>
  | undefined;

async function loadConversationRuntime() {
  conversationRuntimePromise ??= import("merclaw/plugin-sdk/conversation-binding-runtime");

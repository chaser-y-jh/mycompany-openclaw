...
import { createNodeProxyAgent } from "merclaw/plugin-sdk/fetch-runtime";
import {
  captureWsEvent,
  resolveEffectiveDebugProxyUrl,
  resolveDebugProxySettings,
} from "merclaw/plugin-sdk/proxy-capture";
import { danger, warn } from "merclaw/plugin-sdk/runtime-env";
...
type ResolveDiscordGatewayIntentsParams = {
  intentsConfig?: import("merclaw/plugin-sdk/config-contracts").DiscordIntentsConfig;
...
function createGatewayPlugin(params: {
  ...
  class MerClawGatewayPlugin extends discordGateway.GatewayPlugin {
  ...
  return new MerClawGatewayPlugin();
}
...
export function createDiscordGatewayPlugin(params: {
  ...
  return createGatewayPlugin({
    options: {
      ...
      intents,
      // MerClaw registers its own async interaction listener.

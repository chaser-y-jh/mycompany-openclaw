...
import { collectProviderDangerousNameMatchingScopes } from "merclaw/plugin-sdk/runtime-doctor";
...
export function scanDiscordNumericIdEntries(cfg: MerClawConfig): DiscordNumericIdHit[] {
...
export function maybeRepairDiscordNumericIds(
  cfg: MerClawConfig,
  doctorFixCommand: string,
): { config: MerClawConfig; changes: string[]; warnings?: string[] } {
...
function collectDiscordMutableAllowlistWarnings(cfg: MerClawConfig): string[] {

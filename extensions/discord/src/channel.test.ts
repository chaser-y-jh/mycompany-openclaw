...
function createCfg(): MerClawConfig {
  return {
    channels: {
      discord: {
        enabled: true,
...
function resolveAccount(cfg: MerClawConfig, accountId = "default"): ResolvedDiscordAccount {
  return discordPlugin.config.resolveAccount(cfg, accountId);
}

function startDiscordAccount(cfg: MerClawConfig, accountId = "default") {

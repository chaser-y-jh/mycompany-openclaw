# GitHub Copilot agent runtime (MerClaw plugin)

External MerClaw plugin that registers a `copilot` agent harness backed by `@github/copilot-sdk` and the GitHub Copilot CLI.

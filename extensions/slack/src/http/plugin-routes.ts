...
import type { MerClawPluginApi } from "merclaw/plugin-sdk/channel-plugin-common";
...
function resolveSlackWebhookPaths(config: MerClawPluginApi["config"]): string[] {
...
export function registerSlackPluginHttpRoutes(api: MerClawPluginApi): void {

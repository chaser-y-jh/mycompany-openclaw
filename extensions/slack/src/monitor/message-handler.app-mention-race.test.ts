...
vi.mock("merclaw/plugin-sdk/channel-inbound", async () => {
  const actual = await vi.importActual<typeof import("merclaw/plugin-sdk/channel-inbound")>(
    "merclaw/plugin-sdk/channel-inbound",
  );
  return {
    ...actual,

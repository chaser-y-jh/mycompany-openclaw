...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<MerClawConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<MerClawConfig["channels"]>["slack"]>>,
): MerClawConfig {
  return {
    channels: {
      slack: {

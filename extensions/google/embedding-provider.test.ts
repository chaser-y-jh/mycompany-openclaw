...
vi.mock("merclaw/plugin-sdk/memory-core-host-engine-embeddings", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("merclaw/plugin-sdk/memory-core-host-engine-embeddings")>();
  return {
    ...actual,

...
import { buildOauthProviderAuthResult } from "merclaw/plugin-sdk/provider-auth-result";
import type { ProviderPlugin } from "merclaw/plugin-sdk/provider-model-shared";
import { fetchGeminiUsage } from "merclaw/plugin-sdk/provider-usage";
...
export function registerGoogleGeminiCliProvider(api: MerClawPluginApi) {

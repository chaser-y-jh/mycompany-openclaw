...
export { mutateConfigFile, replaceConfigFile } from "merclaw/plugin-sdk/config-mutation";
export {
  type BrowserConfig,
...
export { resolveGatewayPort } from "merclaw/plugin-sdk/core";
export {
  CONFIG_DIR,
  escapeRegExp,
  resolveUserPath,
  shortenHomePath,
} from "merclaw/plugin-sdk/text-utility-runtime";

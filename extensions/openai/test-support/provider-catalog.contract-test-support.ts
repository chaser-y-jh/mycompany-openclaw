...
import type { ProviderPlugin } from "merclaw/plugin-sdk/provider-test-contracts";
...
vi.mock("merclaw/plugin-sdk/provider-catalog-runtime", async () => {
  const actual = await vi.importActual<
    typeof import("merclaw/plugin-sdk/provider-catalog-runtime")
  >("merclaw/plugin-sdk/provider-catalog-runtime");

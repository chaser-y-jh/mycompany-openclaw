import type { ChannelSetupAdapter, MerClawConfig } from "merclaw/plugin-sdk/setup";
import { createSetupInputPresenceValidator } from "merclaw/plugin-sdk/setup";
...
export function isLineConfigured(cfg: MerClawConfig, accountId: string): boolean {

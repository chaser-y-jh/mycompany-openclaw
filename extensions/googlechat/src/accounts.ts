...
import { safeParseJsonWithSchema, safeParseWithSchema } from "merclaw/plugin-sdk/extension-shared";
import { mergePairLoopGuardConfig } from "merclaw/plugin-sdk/pair-loop-guard-runtime";
import { isSecretRef } from "merclaw/plugin-sdk/secret-input";
...
export function listEnabledGoogleChatAccounts(cfg: MerClawConfig): ResolvedGoogleChatAccount[] {

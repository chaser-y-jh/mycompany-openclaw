...
import type { FixedWindowRateLimiter } from "merclaw/plugin-sdk/webhook-ingress";
...
vi.mock("merclaw/plugin-sdk/webhook-request-guards", () => ({
  readJsonWebhookBodyOrReject,
}));

vi.mock("merclaw/plugin-sdk/webhook-targets", () => ({
...
describe("googlechat monitor webhook", () => {
  ...
  afterAll(() => {
    vi.doUnmock("merclaw/plugin-sdk/webhook-request-guards");
    vi.doUnmock("merclaw/plugin-sdk/webhook-targets");
    vi.doUnmock("./auth.js");
    vi.resetModules();
  });

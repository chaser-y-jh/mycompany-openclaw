...
function resolveGoogleChatAccountImpl(params: { cfg: MerClawConfig; accountId?: string | null }) {
...
vi.mock("./channel.deps.runtime.js", () => {
  return {
    ...
    listGoogleChatAccountIds: (cfg: MerClawConfig) => {
...
function createGoogleChatCfg(): MerClawConfig {
  return {
    channels: {
      googlechat: {
        enabled: true,

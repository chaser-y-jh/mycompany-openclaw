...
import { updateAuthProfileStoreWithLock } from "merclaw/plugin-sdk/provider-auth";
import {
...
async function buildOpenCodeSecretCandidates(
  ...
  // MerClaw's Copilot token profile cannot preserve OpenCode enterprise routing yet.

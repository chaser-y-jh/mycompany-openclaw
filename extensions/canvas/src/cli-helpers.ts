...
import { resolvePreferredMerClawTmpDir } from "merclaw/plugin-sdk/security-runtime";
import { asRecord, readStringValue } from "merclaw/plugin-sdk/string-coerce-runtime";
...
function resolveTempPathParts(opts: { ext: string; tmpDir?: string; id?: string }) {
  const tmpDir = opts.tmpDir ?? resolvePreferredMerClawTmpDir();
  if (!opts.tmpDir) {

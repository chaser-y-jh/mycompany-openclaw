import { lowercasePreservingWhitespace } from "merclaw/plugin-sdk/string-coerce-runtime";

export const A2UI_PATH = "/__merclaw__/a2ui";

export const CANVAS_HOST_PATH = "/__merclaw__/canvas";

export const CANVAS_WS_PATH = "/__merclaw__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.merclawCanvasA2UIAction.postMessage(...)
  // - Android: window.merclawCanvasA2UIAction.postMessage(...)
  const handlerNames = ["merclawCanvasA2UIAction"];
  ...
  globalThis.MerClaw = globalThis.MerClaw ?? {};
  globalThis.MerClaw.postMessage = postToNode;
  globalThis.MerClaw.sendUserAction = sendUserAction;
  globalThis.merclawPostMessage = postToNode;
  globalThis.merclawSendUserAction = sendUserAction;

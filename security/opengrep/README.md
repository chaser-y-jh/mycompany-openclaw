...
`precise.yml` is MerClaw's shipped precise OpenGrep rulepack. Each rule is tied
...
Some MerClaw paths are excluded by `.gitignore` for build reasons even though

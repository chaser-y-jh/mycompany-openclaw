> [!WARNING]
> **这不是 [merclaw/merclaw](https://github.com/merclaw/merclaw) 官方仓库。**
>
> 本仓库为 **个人/教育场景 fork**：[`chaser-y-jh/mycompany-merclaw`](https://github.com/chaser-y-jh/mycompany-merclaw)  
> 在 upstream MerClaw 基础上做定制，与官方发行版、文档、Discord 支持无关。
>
> | 项目 | 说明 |
> |------|------|
> | **Upstream** | [merclaw/merclaw](https://github.com/merclaw/merclaw) |
> | **本 fork 定制** | Phase 0：教育场景认证扩展（用户体系、角色、RBAC）等 |
> | **维护者** | chaser-y-jh |
>
> 使用问题请先查本仓库 Issues；通用 MerClaw 问题请参考官方文档。

---

# 🦞 MerClaw — Personal AI Assistant（上游 README，下文为原版说明）

<p align="center">
    <picture>
        <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/merclaw/merclaw/main/docs/assets/merclaw-logo-text-dark.svg">
        <img src="https://raw.githubusercontent.com/merclaw/merclaw/main/docs/assets/merclaw-logo-text.svg" alt="MerClaw" width="500">
    </picture>
</p>
...
<p align="center">
  <a href="https://github.com/merclaw/merclaw/actions/workflows/ci.yml?branch=main"><img src="https://img.shields.io/github/actions/workflow/status/merclaw/merclaw/ci.yml?branch=main&style=for-the-badge" alt="CI status"></a>
  <a href="https://github.com/merclaw/merclaw/releases"><img src="https://img.shields.io/github/v/release/merclaw/merclaw?include_prereleases&style=for-the-badge" alt="GitHub release"></a>
  <a href="https://discord.gg/clawd"><img src="https://img.shields.io/discord/1456350064065904867?label=Discord&logo=discord&logoColor=white&color=5865F2&style=for-the-badge" alt="Discord"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg?style=for-the-badge" alt="MIT License"></a>
</p>

**MerClaw** is a _personal AI assistant_ you run on your own devices.
...
[Website](https://merclaw.ai) · [Docs](https://docs.merclaw.ai) · [Vision](VISION.md) · [Third-party notices](THIRD_PARTY_NOTICES.md) · [DeepWiki](https://deepwiki.com/merclaw/merclaw) · [Getting Started](https://docs.merclaw.ai/start/getting-started) · [Updating](https://docs.merclaw.ai/install/updating) · [Showcase](https://docs.merclaw.ai/start/showcase) · [FAQ](https://docs.merclaw.ai/help/faq) · [Onboarding](https://docs.merclaw.ai/start/wizard) · [Nix](https://github.com/merclaw/nix-merclaw) · [Docker](https://docs.merclaw.ai/install/docker) · [Discord](https://discord.gg/clawd)

New install? Start here: [Getting started](https://docs.merclaw.ai/start/getting-started)

Preferred setup: run `merclaw onboard` in your terminal.
MerClaw Onboard guides you step by step through setting up the gateway, workspace, channels, and skills. It is the recommended CLI setup path and works on **macOS, Linux, and Windows (via WSL2; strongly recommended)**.
  ...
  <tr>
    <td align="center" width="16.66%">
      <a href="https://openai.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/merclaw/merclaw/main/docs/assets/sponsors/openai-light.svg">
          <img src="https://raw.githubusercontent.com/merclaw/merclaw/main/docs/assets/sponsors/openai.svg" alt="OpenAI" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://github.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/merclaw/merclaw/main/docs/assets/sponsors/github-light.svg">
          <img src="https://raw.githubusercontent.com/merclaw/merclaw/main/docs/assets/sponsors/github.svg" alt="GitHub" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://www.nvidia.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/merclaw/merclaw/main/docs/assets/sponsors/nvidia.svg">
          <img src="https://raw.githubusercontent.com/merclaw/merclaw/main/docs/assets/sponsors/nvidia-dark.svg" alt="NVIDIA" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://vercel.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/merclaw/merclaw/main/docs/assets/sponsors/vercel-light.svg">
          <img src="https://raw.githubusercontent.com/merclaw/merclaw/main/docs/assets/sponsors/vercel.svg" alt="Vercel" height="24">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://blacksmith.sh/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/merclaw/merclaw/main/docs/assets/sponsors/blacksmith-light.svg">
          <img src="https://raw.githubusercontent.com/merclaw/merclaw/main/docs/assets/sponsors/blacksmith.svg" alt="Blacksmith" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://www.convex.dev/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/merclaw/merclaw/main/docs/assets/sponsors/convex-light.svg">
          <img src="https://raw.githubusercontent.com/merclaw/merclaw/main/docs/assets/sponsors/convex.svg" alt="Convex" height="24">
        </picture>
      </a>
    </td>
  </tr>
...
Model note: while many providers and models are supported, prefer a current flagship model from the provider you trust and already use. See [Onboarding](https://docs.merclaw.ai/start/wizard).
...
```bash
npm install -g merclaw@latest
# or: pnpm add -g merclaw@latest

merclaw onboard --install-daemon
```

MerClaw Onboard installs the Gateway daemon (launchd/systemd user service) so it stays running.

## Quick start (TL;DR)

Runtime: **Node 24 (recommended) or Node 22.19+**.

Full beginner guide (auth, pairing, channels): [Getting started](https://docs.merclaw.ai/start/getting-started)
...
merclaw gateway --port 18789 --verbose
```
...
```bash
# Send a message
merclaw message send --target +1234567890 --message "Hello from MerClaw"
...
merclaw agent --message "Ship checklist" --thinking high
```

Upgrading? [Updating guide](https://docs.merclaw.ai/install/updating) (and run `merclaw doctor`).

Models config + CLI: [Models](https://docs.merclaw.ai/concepts/models). Auth profile rotation + fallbacks: [Model failover](https://docs.merclaw.ai/concepts/model-failover).

## Security defaults (DM access)

MerClaw connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.merclaw.ai/gateway/security).
Before remote exposure, use the [Gateway exposure runbook](https://docs.merclaw.ai/gateway/security/exposure-runbook).

Default behavior on Telegram/WhatsApp/Signal/iMessage/Microsoft Teams/Discord/Google Chat/Slack:

- **DM pairing** (`dmPolicy="pairing"` / `channels.discord.dmPolicy="pairing"` / `channels.slack.dmPolicy="pairing"`; legacy: `channels.discord.dm.policy`, `channels.slack.dm.policy`): unknown senders receive a short pairing code and the bot does not process their message.
- Approve with: `merclaw pairing approve <channel> <code>` (then the sender is added to a local allowlist store).
- Public inbound DMs require an explicit opt-in: set `dmPolicy="open"` and include `"*"` in the channel allowlist (`allowFrom` / `channels.discord.allowFrom` / `channels.slack.allowFrom`; legacy: `channels.discord.dm.allowFrom`, `channels.slack.dm.allowFrom`).

Run `merclaw doctor` to surface risky/misconfigured DM policies.

## Highlights

- **[Local-first Gateway](https://docs.merclaw.ai/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.merclaw.ai/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, IRC, Microsoft Teams, Matrix, Feishu, LINE, Mattermost, Nextcloud Talk, Nostr, Synology Chat, Tlon, Twitch, Zalo, Zalo Personal, WeChat, QQ, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.merclaw.ai/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.merclaw.ai/nodes/voicewake) + [Talk Mode](https://docs.merclaw.ai/nodes/talk)** — wake words on macOS/iOS and continuous voice on Android (ElevenLabs + system TTS fallback).
- **[Live Canvas](https://docs.merclaw.ai/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.merclaw.ai/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.merclaw.ai/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.merclaw.ai/platforms/macos)** — macOS menu bar app + iOS/Android [nodes](https://docs.merclaw.ai/nodes).
- **[Onboarding](https://docs.merclaw.ai/start/wizard) + [skills](https://docs.merclaw.ai/tools/skills)** — onboarding-driven setup with bundled/managed/workspace skills.
...
- Before exposing anything remotely, read [Security](https://docs.merclaw.ai/gateway/security), [Gateway exposure runbook](https://docs.merclaw.ai/gateway/security/exposure-runbook), [Sandboxing](https://docs.merclaw.ai/gateway/sandboxing), and [Configuration](https://docs.merclaw.ai/gateway/configuration).
...
- Architecture overview: [Architecture](https://docs.merclaw.ai/concepts/architecture)

## Docs by goal

- New here: [Getting started](https://docs.merclaw.ai/start/getting-started), [Onboarding](https://docs.merclaw.ai/start/wizard), [Updating](https://docs.merclaw.ai/install/updating)
- Channel setup: [Channels index](https://docs.merclaw.ai/channels), [WhatsApp](https://docs.merclaw.ai/channels/whatsapp), [Telegram](https://docs.merclaw.ai/channels/telegram), [Discord](https://docs.merclaw.ai/channels/discord), [Slack](https://docs.merclaw.ai/channels/slack)
- Apps + nodes: [macOS](https://docs.merclaw.ai/platforms/macos), [iOS](https://docs.merclaw.ai/platforms/ios), [Android](https://docs.merclaw.ai/platforms/android), [Nodes](https://docs.merclaw.ai/nodes)
- Config + security: [Configuration](https://docs.merclaw.ai/gateway/configuration), [Security](https://docs.merclaw.ai/gateway/security), [Exposure runbook](https://docs.merclaw.ai/gateway/security/exposure-runbook), [Sandboxing](https://docs.merclaw.ai/gateway/sandboxing)
- Remote + web: [Gateway](https://docs.merclaw.ai/gateway), [Remote access](https://docs.merclaw.ai/gateway/remote), [Tailscale](https://docs.merclaw.ai/gateway/tailscale), [Web surfaces](https://docs.merclaw.ai/web)
- Tools + automation: [Tools](https://docs.merclaw.ai/tools), [Skills](https://docs.merclaw.ai/tools/skills), [Cron jobs](https://docs.merclaw.ai/automation/cron-jobs), [Webhooks](https://docs.merclaw.ai/automation/webhook), [Gmail Pub/Sub](https://docs.merclaw.ai/automation/gmail-pubsub)
- Internals: [Architecture](https://docs.merclaw.ai/concepts/architecture), [Agent](https://docs.merclaw.ai/concepts/agent), [Session model](https://docs.merclaw.ai/concepts/session), [Gateway protocol](https://docs.merclaw.ai/reference/rpc)
- Troubleshooting: [Channel troubleshooting](https://docs.merclaw.ai/channels/troubleshooting), [Logging](https://docs.merclaw.ai/logging), [Docs home](https://docs.merclaw.ai)
...
Note: signed builds required for macOS permissions to stick across rebuilds (see [macOS Permissions](https://docs.merclaw.ai/platforms/mac/permissions)).

### iOS node (optional)

- Pairs as a node over the Gateway WebSocket (device pairing).
- Voice trigger forwarding + Canvas surface.
- Controlled via `merclaw nodes …`.

Runbook: [iOS connect](https://docs.merclaw.ai/platforms/ios).

### Android node (optional)

- Pairs as a WS node via device pairing (`merclaw devices ...`).
- Exposes Connect/Chat/Voice tabs plus Canvas, Camera, Screen capture, and Android device command families.
- Runbook: [Android connect](https://docs.merclaw.ai/platforms/android).
...
```bash
git clone https://github.com/merclaw/merclaw.git
cd merclaw

pnpm install

# First run only (or after resetting local MerClaw config/workspace)
pnpm merclaw setup
...
`pnpm merclaw setup` writes the local config/workspace needed for `pnpm gateway:watch`. It is safe to re-run, but you normally only need it on first setup or after resetting local state. `pnpm gateway:watch` does not rebuild `dist/control-ui`, so rerun `pnpm ui:build` after `ui/` changes or use `pnpm ui:dev` when iterating on the Control UI. If you want this checkout to run onboarding directly, use `pnpm merclaw onboard --install-daemon`.

Note: `pnpm merclaw ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `merclaw` binary, while `pnpm gateway:watch` rebuilds the runtime on demand during the dev loop.
...
Switch channels (git + npm): `merclaw update --channel stable|beta|dev`.
Details: [Development channels](https://docs.merclaw.ai/install/development-channels).

## Agent workspace + skills

- Workspace root: `~/.merclaw/workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/.merclaw/workspace/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.merclaw/merclaw.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.merclaw.ai/gateway/configuration)

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=merclaw/merclaw&type=date&legend=top-left)](https://www.star-history.com/#merclaw/merclaw&type=date&legend=top-left)

## Molty

MerClaw was built for **Molty**, a space lobster AI assistant. 🦞
by Peter Steinberger and the community.

- [merclaw.ai](https://merclaw.ai)
- [soul.md](https://soul.md)
- [steipete.me](https://steipete.me)
- [@merclaw](https://x.com/merclaw)

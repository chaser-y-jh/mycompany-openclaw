...
- MERCLAW_IOS_VERSION = exact canonical iOS version
- MERCLAW_MARKETING_VERSION = short iOS/App Store version
- MERCLAW_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
MERCLAW_IOS_VERSION = ${IOS_VERSION}
MERCLAW_MARKETING_VERSION = ${MARKETING_VERSION}
MERCLAW_BUILD_VERSION = ${BUILD_NUMBER}
EOF

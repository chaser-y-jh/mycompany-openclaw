...
const pierreDiffsEmptySideEffectNamespace = "merclaw-diffs-empty-side-effect";
...
export function createPierreDiffsSideEffectImportPlugin() {
  return {
    name: "merclaw-diffs-pierre-side-effect-imports",
    setup(buildContext) {
  ...
  const result = await build({
    ...
    plugins: [
      ...
      ...(target.shikiAlias
        ? [
            {
              name: "merclaw-diffs-curated-shiki",
              setup(buildContext) {

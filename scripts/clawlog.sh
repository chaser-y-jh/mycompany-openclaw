...
show_usage() {
    cat << EOF
clawlog - MerClaw Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View MerClaw logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    MerClaw logs flow through the macOS unified log (subsystem: ai.merclaw).

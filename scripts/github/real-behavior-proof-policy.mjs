...
const CLAWSWEEPER_BOT_LOGINS = new Set(["clawsweeper[bot]", "merclaw-clawsweeper[bot]"]);
...
const liveCommandRegex =
  /\b(?:merclaw|node|docker|curl|gh|ssh|adb|xcrun|xcodebuild|open|npm\s+run|pnpm\s+merclaw)\b/i;

...
IMAGE_NAME="$(docker_e2e_resolve_image "merclaw-crestodian-rescue-e2e" MERCLAW_CRESTODIAN_RESCUE_E2E_IMAGE)"
CONTAINER_NAME="merclaw-crestodian-rescue-e2e-$$"
RUN_LOG="$(mktemp -t merclaw-crestodian-rescue-log.XXXXXX)"
...
MERCLAW_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 crestodian-rescue empty)"

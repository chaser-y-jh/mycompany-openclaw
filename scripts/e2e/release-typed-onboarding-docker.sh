...
IMAGE_NAME="$(docker_e2e_resolve_image "merclaw-release-typed-onboarding-e2e" MERCLAW_RELEASE_TYPED_ONBOARDING_E2E_IMAGE)"
SKIP_BUILD="${MERCLAW_RELEASE_TYPED_ONBOARDING_E2E_SKIP_BUILD:-0}"
run_log=""
cleanup() {
...
PACKAGE_TGZ="$(docker_e2e_prepare_package_tgz release-typed-onboarding "${MERCLAW_CURRENT_PACKAGE_TGZ:-}")"
...
MERCLAW_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 release-typed-onboarding empty)"

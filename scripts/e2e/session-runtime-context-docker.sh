...
IMAGE_NAME="$(docker_e2e_resolve_image "merclaw-session-runtime-context-e2e" MERCLAW_SESSION_RUNTIME_CONTEXT_E2E_IMAGE)"
CONTAINER_NAME="merclaw-session-runtime-context-e2e-$$"
RUN_LOG="$(mktemp -t merclaw-session-runtime-context-log.XXXXXX)"

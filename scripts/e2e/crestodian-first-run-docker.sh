...
IMAGE_NAME="$(docker_e2e_resolve_image "merclaw-crestodian-first-run-e2e" MERCLAW_CRESTODIAN_FIRST_RUN_E2E_IMAGE)"
CONTAINER_NAME="merclaw-crestodian-first-run-e2e-$$"
RUN_LOG="$(mktemp -t merclaw-crestodian-first-run-log.XXXXXX)"
...
MERCLAW_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 crestodian-first-run empty)"

...
MODEL_REF="${MERCLAW_OPENAI_CHAT_TOOLS_MODEL:?missing MERCLAW_OPENAI_CHAT_TOOLS_MODEL}"
GATEWAY_LOG="/tmp/merclaw-openai-chat-tools-gateway.log"
CLIENT_LOG="/tmp/merclaw-openai-chat-tools-client.log"
gateway_pid=""
...
PORT="$PORT" MERCLAW_GATEWAY_TOKEN="$TOKEN" MODEL_REF="$MODEL_REF" \

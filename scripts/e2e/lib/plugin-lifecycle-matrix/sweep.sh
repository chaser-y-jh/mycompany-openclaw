...
merclaw_e2e_install_package /tmp/merclaw-plugin-lifecycle-install.log "mounted MerClaw package" /tmp/npm-prefix
...
pack_root="$(mktemp -d "/tmp/merclaw-plugin-lifecycle-pack.XXXXXX")"
registry_root="$(mktemp -d "/tmp/merclaw-plugin-lifecycle-registry.XXXXXX")"

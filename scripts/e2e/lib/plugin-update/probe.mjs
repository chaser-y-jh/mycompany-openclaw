...
const pluginRecordSnapshot = () => {
  const config = readJson(merclawPath("merclaw.json"));
...
function seedInstallState() {
  writeJson(merclawPath("extensions", "lossless-claw", "package.json"), {
    name: "@example/lossless-claw",
    version: "0.9.0",
  });
  writeJson(process.env.MERCLAW_CONFIG_PATH, { plugins: {} });
  writeJson(merclawPath("plugins", "installs.json"), {
    version: 1,
    warning: "DO NOT EDIT. This file is generated by MerClaw plugin registry commands.",
...
function isCorruptPluginDisabledAfterUpdate(evidence, pluginId) {
  ...
  return (
    ...
    message.includes("MerClaw will continue without it")
  );
}
...
function assertCorruptPluginDetails(plugins, pluginId) {
  ...
  const expectedFragments = disabledAfterFailure
    ? [
        ...
        "MerClaw will continue without it",

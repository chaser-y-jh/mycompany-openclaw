...
function assertOnboardState() {
  ...
  if (!fs.existsSync(configPath)) {
    throw new Error("onboard did not write merclaw.json");
  }
  ...
  if (authRaw.includes("sk-merclaw-npm-onboard-e2e")) {
...
function assertMockModelConfig() {
  ...
  if (provider?.agentRuntime?.id !== "merclaw") {
...
function assertAgentTurn() {
  ...
  assertAgentReplyContainsMarker(marker, "/tmp/merclaw-agent.combined");

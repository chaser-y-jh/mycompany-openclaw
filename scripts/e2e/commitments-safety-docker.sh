...
IMAGE_NAME="$(docker_e2e_resolve_image "merclaw-commitments-safety-e2e" MERCLAW_COMMITMENTS_SAFETY_E2E_IMAGE)"
CONTAINER_NAME="merclaw-commitments-safety-e2e-$$"
RUN_LOG="$(mktemp -t merclaw-commitments-safety-log.XXXXXX)"

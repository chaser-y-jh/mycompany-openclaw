...
# Output:
# - dist/MerClaw.app
# - dist/MerClaw-<version>.zip
# - dist/MerClaw-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.merclaw.mac}"
...
ZIP="$ROOT_DIR/dist/MerClaw-$VERSION.zip"
DMG="$ROOT_DIR/dist/MerClaw-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/MerClaw-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/MerClaw-$VERSION.dSYM.zip"

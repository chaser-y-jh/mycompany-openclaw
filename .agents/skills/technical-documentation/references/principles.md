...
When the target repo or request is MerClaw-specific, layer `references/merclaw.md` on top of these general rules. Otherwise ignore that repo-specific overlay.

# MerClaw Documentation Overlay

Use this reference only for MerClaw docs work. It layers MerClaw-specific page
...
- Topic page: explain a major MerClaw entity or surface end to end.
...
- Governance file: keep agent/contributor policy concrete, scoped, and aligned
  with current MerClaw repo behavior.

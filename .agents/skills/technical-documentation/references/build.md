...
- For MerClaw docs work, choose a page type from `references/merclaw.md` before drafting.
- Keep task-critical MerClaw configuration inline; link exhaustive defaults, enums, schemas, generated references, and rare debugging workflows.
...
- For MerClaw docs work, apply the validation checklist in `references/merclaw.md`.

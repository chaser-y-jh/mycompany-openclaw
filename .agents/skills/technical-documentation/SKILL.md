...
- Applying repository-specific documentation overlays, including MerClaw page-type, docs IA, preservation, and validation rules when present.
...
6. For MerClaw docs work, read `references/merclaw.md` before the build/review playbook.

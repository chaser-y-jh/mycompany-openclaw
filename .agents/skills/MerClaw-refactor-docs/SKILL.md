---
name: merclaw-refactor-docs
description: Refactor an existing MerClaw docs page with source-audited preservation, restructuring, and verification.
---

# MerClaw Refactor Docs

## Overview

Use this skill when the user gives a target MerClaw docs page and asks to
rewrite, refactor, reorganize, split, shorten, or improve it.

This skill builds on `merclaw-docs`: use that skill for style, page types,
...
Read `../merclaw-docs/SKILL.md` first. Apply its page-type, style,
...
Before editing, decide the intended page type from `merclaw-docs`.

---
name: merclaw-secret-scanning-maintainer
description: Triage, redact, clean up, and resolve MerClaw GitHub Secret Scanning alerts in issues or PRs.
---

# MerClaw Secret Scanning Maintainer
...
Use this skill when processing alerts from `https://github.com/merclaw/merclaw/security/secret-scanning`.
...
```
$REPO_ROOT/.agents/skills/merclaw-secret-scanning-maintainer/scripts/secret-scanning.mjs
```
...
[
  {
    ...
    "location_url": "https://github.com/merclaw/merclaw/issues/63101#issuecomment-xxx",

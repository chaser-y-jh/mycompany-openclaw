---
name: merclaw-ghsa-maintainer
description: "Inspect, patch, validate, publish, or confirm MerClaw GHSA security advisories and private-fork state."
---

# MerClaw GHSA Maintainer

Use this skill for repo security advisory workflow only. Keep general release work in `release-merclaw-maintainer`.
...
```bash
fork=$(gh api /repos/merclaw/merclaw/security-advisories/<GHSA> | jq -r .private_fork.full_name)
...
```bash
gh api -X PATCH /repos/merclaw/merclaw/security-advisories/<GHSA> \
